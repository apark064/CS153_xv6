...
8010005b:	e8 a0 41 00 00       	call   80104200 <initlock>
  bcache.head.next = &bcache.head;
...
801000e3:	8b 7d 0c             	mov    0xc(%ebp),%edi
  acquire(&bcache.lock);
801000e6:	e8 85 42 00 00       	call   80104370 <acquire>
...
80100161:	e8 7a 42 00 00       	call   801043e0 <release>
      acquiresleep(&b->lock);
...
80100209:	e8 62 41 00 00       	call   80104370 <acquire>
  b->refcnt--;
  if (b->refcnt == 0) {
...
8010024f:	5d                   	pop    %ebp
  release(&bcache.lock);
80100250:	e9 8b 41 00 00       	jmp    801043e0 <release>
    panic("brelse");
...
8010028e:	e8 dd 40 00 00       	call   80104370 <acquire>
  while(n > 0){
...
80100311:	e8 ca 40 00 00       	call   801043e0 <release>
  ilock(ip);
...
8010032f:	e8 ac 40 00 00       	call   801043e0 <release>
        ilock(ip);
...
80100394:	e8 b7 02 00 00       	call   80100650 <cprintf>
  cprintf("\n");
80100399:	c7 04 24 b9 74 10 80 	movl   $0x801074b9,(%esp)
801003a0:	e8 ab 02 00 00       	call   80100650 <cprintf>
  getcallerpcs(&s, pcs);
801003a5:	8d 45 08             	lea    0x8(%ebp),%eax
801003a8:	89 5c 24 04          	mov    %ebx,0x4(%esp)
801003ac:	89 04 24             	mov    %eax,(%esp)
801003af:	e8 6c 3e 00 00       	call   80104220 <getcallerpcs>
...
801004fc:	e8 cf 3f 00 00       	call   801044d0 <memmove>
    memset(crt+pos, 0, sizeof(crt[0])*(24*80 - pos));
...
80100518:	00 
80100519:	e8 12 3f 00 00       	call   80104430 <memset>
...
8010060e:	e8 5d 3d 00 00       	call   80104370 <acquire>
...
80100636:	e8 a5 3d 00 00       	call   801043e0 <release>
  ilock(ip);
...
801006f3:	e8 e8 3c 00 00       	call   801043e0 <release>
}
...
80100797:	e8 d4 3b 00 00       	call   80104370 <acquire>
...
801007c5:	e8 a6 3b 00 00       	call   80104370 <acquire>
...
80100827:	e8 b4 3b 00 00       	call   801043e0 <release>
  if(doprocdump) {
...
80100965:	e8 96 38 00 00       	call   80104200 <initlock>
...
80100c01:	e8 4a 3a 00 00       	call   80104650 <strlen>
...
80100c12:	e8 39 3a 00 00       	call   80104650 <strlen>
...
80100cf1:	e8 1a 39 00 00       	call   80104610 <safestrcpy>
  curproc->pgdir = pgdir;
...
80100d65:	e8 96 34 00 00       	call   80104200 <initlock>
}
80100d6a:	c9                   	leave  
80100d6b:	c3                   	ret    
...
80100d83:	e8 e8 35 00 00       	call   80104370 <acquire>
...
80100da9:	c7 43 04 01 00 00 00 	movl   $0x1,0x4(%ebx)
      release(&ftable.lock);
80100db0:	e8 2b 36 00 00       	call   801043e0 <release>
      return f;
    }
  }
  release(&ftable.lock);
...
80100dc7:	e8 14 36 00 00       	call   801043e0 <release>
}
...
80100df1:	e8 7a 35 00 00       	call   80104370 <acquire>
  if(f->ref < 1)
...
80100e0a:	e8 d1 35 00 00       	call   801043e0 <release>
  return f;
}
...
80100e43:	e8 28 35 00 00       	call   80104370 <acquire>
  if(f->ref < 1)
...
80100e6a:	5d                   	pop    %ebp
    release(&ftable.lock);
80100e6b:	e9 70 35 00 00       	jmp    801043e0 <release>
  ff = *f;
...
80100e8c:	89 45 e0             	mov    %eax,-0x20(%ebp)
  release(&ftable.lock);
80100e8f:	e8 4c 35 00 00       	call   801043e0 <release>
  if(ff.type == FD_PIPE)
...
80101278:	e8 b3 31 00 00       	call   80104430 <memset>
  log_write(bp);
...
801012b9:	89 55 e4             	mov    %edx,-0x1c(%ebp)
  acquire(&icache.lock);
801012bc:	e8 af 30 00 00       	call   80104370 <acquire>
  for(ip = &icache.inode[0]; ip < &icache.inode[NINODE]; ip++){
...
801012f6:	89 4b 08             	mov    %ecx,0x8(%ebx)
      release(&icache.lock);
801012f9:	e8 e2 30 00 00       	call   801043e0 <release>
  ip->ref = 1;
  ip->valid = 0;
  release(&icache.lock);
...
8010133e:	e8 9d 30 00 00       	call   801043e0 <release>
}
...
80101452:	e8 79 30 00 00       	call   801044d0 <memmove>
  brelse(bp);
...
8010148b:	e8 70 2d 00 00       	call   80104200 <initlock>
...
801014a0:	80 
801014a1:	e8 2a 2c 00 00       	call   801040d0 <initsleeplock>
  for(i = 0; i < NINODE; i++) {
...
801015a9:	e8 82 2e 00 00       	call   80104430 <memset>
      dip->type = type;
...
8010165f:	00 
80101660:	e8 6b 2e 00 00       	call   801044d0 <memmove>
  log_write(bp);
...
80101691:	e8 da 2c 00 00       	call   80104370 <acquire>
  ip->ref++;
80101696:	83 43 08 01          	addl   $0x1,0x8(%ebx)
  release(&icache.lock);
8010169a:	c7 04 24 e0 09 11 80 	movl   $0x801109e0,(%esp)
801016a1:	e8 3a 2d 00 00       	call   801043e0 <release>
}
...
801016d4:	e8 37 2a 00 00       	call   80104110 <acquiresleep>
  if(ip->valid == 0){
...
8010174b:	e8 80 2d 00 00       	call   801044d0 <memmove>
    brelse(bp);
...
801017a5:	e8 06 2a 00 00       	call   801041b0 <holdingsleep>
...
801017bd:	5d                   	pop    %ebp
  releasesleep(&ip->lock);
801017be:	e9 ad 29 00 00       	jmp    80104170 <releasesleep>
    panic("iunlock");
...
801017e2:	e8 29 29 00 00       	call   80104110 <acquiresleep>
...
801017f8:	e8 73 29 00 00       	call   80104170 <releasesleep>
  acquire(&icache.lock);
801017fd:	c7 04 24 e0 09 11 80 	movl   $0x801109e0,(%esp)
80101804:	e8 67 2b 00 00       	call   80104370 <acquire>
  ip->ref--;
...
8010181a:	5d                   	pop    %ebp
  release(&icache.lock);
8010181b:	e9 c0 2b 00 00       	jmp    801043e0 <release>
    acquire(&icache.lock);
80101820:	c7 04 24 e0 09 11 80 	movl   $0x801109e0,(%esp)
80101827:	e8 44 2b 00 00       	call   80104370 <acquire>
    int r = ip->ref;
8010182c:	8b 5e 08             	mov    0x8(%esi),%ebx
    release(&icache.lock);
8010182f:	c7 04 24 e0 09 11 80 	movl   $0x801109e0,(%esp)
80101836:	e8 a5 2b 00 00       	call   801043e0 <release>
    if(r == 1){
...
80101a08:	e8 c3 2a 00 00       	call   801044d0 <memmove>
    brelse(bp);
...
80101b04:	e8 c7 29 00 00       	call   801044d0 <memmove>
    log_write(bp);
...
80101bab:	e8 a0 29 00 00       	call   80104550 <strncmp>
}
80101bb0:	c9                   	leave  
80101bb1:	c3                   	ret    
...
80101c29:	e8 22 29 00 00       	call   80104550 <strncmp>
      continue;
...
80101ca8:	e8 c3 26 00 00       	call   80104370 <acquire>
  ip->ref++;
80101cad:	83 46 08 01          	addl   $0x1,0x8(%esi)
  release(&icache.lock);
80101cb1:	c7 04 24 e0 09 11 80 	movl   $0x801109e0,(%esp)
80101cb8:	e8 23 27 00 00       	call   801043e0 <release>
...
80101d1b:	e8 b0 27 00 00       	call   801044d0 <memmove>
    path++;
...
80101da9:	e8 22 27 00 00       	call   801044d0 <memmove>
    name[len] = 0;
...
80101ea3:	e8 18 27 00 00       	call   801045c0 <strncpy>
  de.inum = inum;
...
80102015:	e8 e6 21 00 00       	call   80104200 <initlock>
...
80102090:	e8 db 22 00 00       	call   80104370 <acquire>
...
801020d6:	e8 05 23 00 00       	call   801043e0 <release>
...
80102130:	e8 7b 20 00 00       	call   801041b0 <holdingsleep>
...
80102166:	e8 05 22 00 00       	call   80104370 <acquire>
...
8010232a:	e8 01 21 00 00       	call   80104430 <memset>
...
801023fa:	e8 01 1e 00 00       	call   80104200 <initlock>
  p = (char*)PGROUNDUP((uint)vstart);
...
801024cd:	e8 0e 1f 00 00       	call   801043e0 <release>
  return (char*)r;
}
...
801024e7:	e8 84 1e 00 00       	call   80104370 <acquire>
...
8010289c:	e8 df 1b 00 00       	call   80104480 <memcmp>
...
801029c7:	e8 04 1b 00 00       	call   801044d0 <memmove>
...
80102a8a:	e8 71 17 00 00       	call   80104200 <initlock>
  readsb(dev, &sb);
...
80102b1d:	e8 4e 18 00 00       	call   80104370 <acquire>
...
80102b65:	a3 bc 26 11 80       	mov    %eax,0x801126bc
      release(&log.lock);
80102b6a:	e8 71 18 00 00       	call   801043e0 <release>
      break;
    }
  }
}
...
80102b90:	e8 db 17 00 00       	call   80104370 <acquire>
  log.outstanding -= 1;
...
80102bc8:	00 00 00 
  release(&log.lock);
80102bcb:	e8 10 18 00 00       	call   801043e0 <release>
  if (log.lh.n > 0) {
...
80102c2f:	e8 9c 18 00 00       	call   801044d0 <memmove>
...
80102c74:	e8 f7 16 00 00       	call   80104370 <acquire>
    log.committing = 0;
...
80102c96:	e8 45 17 00 00       	call   801043e0 <release>
}
...
80102ced:	e8 7e 16 00 00       	call   80104370 <acquire>
  for (i = 0; i < log.lh.n; i++) {
...
80102d3e:	5d                   	pop    %ebp
  release(&log.lock);
80102d3f:	e9 9c 16 00 00       	jmp    801043e0 <release>
...
80102e71:	e8 5a 16 00 00       	call   801044d0 <memmove>
  for(c = cpus; c < cpus+ncpu; c++){
...
80102f4b:	e8 30 15 00 00       	call   80104480 <memcmp>
...
80103006:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  if(memcmp(conf, "PCMP", 4) != 0)
80103009:	e8 72 14 00 00       	call   80104480 <memcmp>
...
801031e6:	80 
801031e7:	e8 14 10 00 00       	call   80104200 <initlock>
  (*f0)->type = FD_PIPE;
...
80103271:	e8 fa 10 00 00       	call   80104370 <acquire>
  if(writable){
...
801032ae:	5d                   	pop    %ebp
    release(&p->lock);
801032af:	e9 2c 11 00 00       	jmp    801043e0 <release>
...
801032db:	e8 00 11 00 00       	call   801043e0 <release>
    kfree((char*)p);
...
80103382:	e8 59 10 00 00       	call   801043e0 <release>
        return -1;
...
801033d2:	e8 09 10 00 00       	call   801043e0 <release>
  return n;
...
801033f2:	e8 79 0f 00 00       	call   80104370 <acquire>
...
8010344b:	e8 90 0f 00 00       	call   801043e0 <release>
...
801034ad:	e8 2e 0f 00 00       	call   801043e0 <release>
}
...
801034d3:	e8 98 0e 00 00       	call   80104370 <acquire>
...
8010350e:	89 43 10             	mov    %eax,0x10(%ebx)
  release(&ptable.lock);
80103511:	e8 ca 0e 00 00       	call   801043e0 <release>
...
8010352d:	89 53 18             	mov    %edx,0x18(%ebx)
  *(uint*)sp = (uint)trapret;
80103530:	c7 40 14 67 56 10 80 	movl   $0x80105667,0x14(%eax)
...
8010354a:	89 43 1c             	mov    %eax,0x1c(%ebx)
  memset(p->context, 0, sizeof *p->context);
8010354d:	e8 de 0e 00 00       	call   80104430 <memset>
...
8010356f:	e8 6c 0e 00 00       	call   801043e0 <release>
}
...
8010359d:	e8 3e 0e 00 00       	call   801043e0 <release>
...
801035f5:	e8 06 0c 00 00       	call   80104200 <initlock>
}
801035fa:	c9                   	leave  
801035fb:	c3                   	ret    
...
80103666:	c7 04 24 24 75 10 80 	movl   $0x80107524,(%esp)
...
801036a4:	83 ec 04             	sub    $0x4,%esp
  pushcli();
801036a7:	e8 d4 0b 00 00       	call   80104280 <pushcli>
  c = mycpu();
801036ac:	e8 4f ff ff ff       	call   80103600 <mycpu>
  p = c->proc;
801036b1:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
801036b7:	e8 04 0c 00 00       	call   801042c0 <popcli>
}
...
80103727:	e8 04 0d 00 00       	call   80104430 <memset>
...
8010378e:	e8 7d 0e 00 00       	call   80104610 <safestrcpy>
  p->cwd = namei("/");
...
80103988:	bb 54 2d 11 80       	mov    $0x80112d54,%ebx
    acquire(&ptable.lock);
8010398d:	e8 de 09 00 00       	call   80104370 <acquire>
...
801039b2:	83 eb 80             	sub    $0xffffff80,%ebx
      switchuvm(p);
801039b5:	e8 56 2e 00 00       	call   80106810 <switchuvm>
...
801039cb:	e8 9b 0c 00 00       	call   8010466b <swtch>
      switchkvm();
801039d0:	e8 1b 2e 00 00       	call   801067f0 <switchkvm>
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
...
801039ef:	e8 ec 09 00 00       	call   801043e0 <release>
  }
...
80103a14:	89 c3                	mov    %eax,%ebx
  if(!holding(&ptable.lock))
80103a16:	e8 15 09 00 00       	call   80104330 <holding>
...
80103a57:	e8 0f 0c 00 00       	call   8010466b <swtch>
  mycpu()->intena = intena;
...
80103b03:	e8 68 08 00 00       	call   80104370 <acquire>
...
80103b9c:	e8 5f fe ff ff       	call   80103a00 <sched>
  panic("zombie exit");
80103ba1:	c7 04 24 7d 74 10 80 	movl   $0x8010747d,(%esp)
80103ba8:	e8 b3 c7 ff ff       	call   80100360 <panic>
    panic("init exiting");
80103bad:	c7 04 24 70 74 10 80 	movl   $0x80107470,(%esp)
...
80103bcd:	e8 9e 07 00 00       	call   80104370 <acquire>
...
80103bea:	e8 f1 07 00 00       	call   801043e0 <release>
}
80103bef:	c9                   	leave  
80103bf0:	c3                   	ret    
...
80103c31:	e8 3a 07 00 00       	call   80104370 <acquire>
    release(lk);
80103c36:	89 34 24             	mov    %esi,(%esp)
80103c39:	e8 a2 07 00 00       	call   801043e0 <release>
  p->chan = chan;
...
80103c5b:	e8 80 07 00 00       	call   801043e0 <release>
    acquire(lk);
...
80103c69:	5d                   	pop    %ebp
    acquire(lk);
80103c6a:	e9 01 07 00 00       	jmp    80104370 <acquire>
80103c6f:	90                   	nop
  p->chan = chan;
...
80103cc8:	89 c6                	mov    %eax,%esi
  acquire(&ptable.lock);
80103cca:	e8 a1 06 00 00       	call   80104370 <acquire>
    havekids = 0;
...
80103d38:	e8 33 2e 00 00       	call   80106b70 <freevm>
	if(status){
...
80103d6d:	e8 6e 06 00 00       	call   801043e0 <release>
}
...
80103d83:	e8 58 06 00 00       	call   801043e0 <release>
}
...
80103db8:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  acquire(&ptable.lock);
80103dbb:	e8 b0 05 00 00       	call   80104370 <acquire>
    found_pid = 0;
...
80103e38:	e8 33 2d 00 00       	call   80106b70 <freevm>
        if(status){
80103e3d:	8b 55 0c             	mov    0xc(%ebp),%edx
        p->pid = 0;
80103e40:	c7 43 10 00 00 00 00 	movl   $0x0,0x10(%ebx)
        p->parent = 0;
80103e47:	c7 43 14 00 00 00 00 	movl   $0x0,0x14(%ebx)
        p->name[0] = 0;
80103e4e:	c6 43 6c 00          	movb   $0x0,0x6c(%ebx)
        if(status){
80103e52:	85 d2                	test   %edx,%edx
        p->killed = 0;
80103e54:	c7 43 24 00 00 00 00 	movl   $0x0,0x24(%ebx)
        p->state = UNUSED;
80103e5b:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
        if(status){
80103e62:	74 08                	je     80103e6c <waitpid+0xcc>
          *status = p->exit_status;
80103e64:	8b 53 7c             	mov    0x7c(%ebx),%edx
80103e67:	8b 45 0c             	mov    0xc(%ebp),%eax
80103e6a:	89 10                	mov    %edx,(%eax)
        release(&ptable.lock);
80103e6c:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
        p->exit_status = 0;
80103e73:	c7 43 7c 00 00 00 00 	movl   $0x0,0x7c(%ebx)
        release(&ptable.lock);
80103e7a:	e8 61 05 00 00       	call   801043e0 <release>
}
80103e7f:	83 c4 1c             	add    $0x1c,%esp
80103e82:	89 f8                	mov    %edi,%eax
80103e84:	5b                   	pop    %ebx
80103e85:	5e                   	pop    %esi
80103e86:	5f                   	pop    %edi
80103e87:	5d                   	pop    %ebp
...
80103e89:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
      return -1;
80103e90:	bf ff ff ff ff       	mov    $0xffffffff,%edi
      release(&ptable.lock);
80103e95:	e8 46 05 00 00       	call   801043e0 <release>
      return -1;
80103e9a:	eb e3                	jmp    80103e7f <waitpid+0xdf>
...
80103eb1:	e8 ba 04 00 00       	call   80104370 <acquire>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
...
80103ef3:	5d                   	pop    %ebp
  release(&ptable.lock);
80103ef4:	e9 e7 04 00 00       	jmp    801043e0 <release>
...
80103f11:	e8 5a 04 00 00       	call   80104370 <acquire>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
...
80103f43:	e8 98 04 00 00       	call   801043e0 <release>
      return 0;
    }
  }
  release(&ptable.lock);
...
80103f67:	e8 74 04 00 00       	call   801043e0 <release>
}
...
80103f94:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    ...
    cprintf("\n");
80103f98:	c7 04 24 b9 74 10 80 	movl   $0x801074b9,(%esp)
...
80103fba:	83 f8 05             	cmp    $0x5,%eax
      state = "???";
80103fbd:	ba a0 74 10 80       	mov    $0x801074a0,%edx
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
80103fc2:	77 11                	ja     80103fd5 <procdump+0x55>
80103fc4:	8b 14 85 4c 75 10 80 	mov    -0x7fef8ab4(,%eax,4),%edx
      state = "???";
80103fcb:	b8 a0 74 10 80       	mov    $0x801074a0,%eax
...
80103fe0:	c7 04 24 a4 74 10 80 	movl   $0x801074a4,(%esp)
...
8010400c:	e8 0f 02 00 00       	call   80104220 <getcallerpcs>
...
80104029:	c7 04 24 e1 6e 10 80 	movl   $0x80106ee1,(%esp)
...
//  exit(0);
  struct proc *curproc = myproc();
80104057:	e8 44 f6 ff ff       	call   801036a0 <myproc>
  cprintf("DEBUG INFO: \n");
8010405c:	c7 04 24 ad 74 10 80 	movl   $0x801074ad,(%esp)
  struct proc *curproc = myproc();
80104063:	89 c3                	mov    %eax,%ebx
  cprintf("DEBUG INFO: \n");
80104065:	e8 e6 c5 ff ff       	call   80100650 <cprintf>
  cprintf("pid:    %d\n", curproc->pid);
8010406a:	8b 43 10             	mov    0x10(%ebx),%eax
8010406d:	c7 04 24 bb 74 10 80 	movl   $0x801074bb,(%esp)
80104074:	89 44 24 04          	mov    %eax,0x4(%esp)
80104078:	e8 d3 c5 ff ff       	call   80100650 <cprintf>
  cprintf("parent: %d\n", curproc->parent);
8010407d:	8b 43 14             	mov    0x14(%ebx),%eax
80104080:	c7 04 24 c7 74 10 80 	movl   $0x801074c7,(%esp)
80104087:	89 44 24 04          	mov    %eax,0x4(%esp)
8010408b:	e8 c0 c5 ff ff       	call   80100650 <cprintf>
  cprintf("killed: %d\n", curproc->killed);
80104090:	8b 43 24             	mov    0x24(%ebx),%eax
80104093:	c7 04 24 d3 74 10 80 	movl   $0x801074d3,(%esp)
8010409a:	89 44 24 04          	mov    %eax,0x4(%esp)
8010409e:	e8 ad c5 ff ff       	call   80100650 <cprintf>
  cprintf("name:   %s\n", curproc->name);
801040a3:	8d 43 6c             	lea    0x6c(%ebx),%eax
801040a6:	89 44 24 04          	mov    %eax,0x4(%esp)
801040aa:	c7 04 24 df 74 10 80 	movl   $0x801074df,(%esp)
801040b1:	e8 9a c5 ff ff       	call   80100650 <cprintf>
  cprintf("state:  %d\n", curproc->state);
801040b6:	8b 43 0c             	mov    0xc(%ebx),%eax
801040b9:	c7 04 24 eb 74 10 80 	movl   $0x801074eb,(%esp)
801040c0:	89 44 24 04          	mov    %eax,0x4(%esp)
801040c4:	e8 87 c5 ff ff       	call   80100650 <cprintf>
}
...
801040da:	c7 44 24 04 64 75 10 	movl   $0x80107564,0x4(%esp)
801040e1:	80 
801040e2:	8d 43 04             	lea    0x4(%ebx),%eax
801040e5:	89 04 24             	mov    %eax,(%esp)
801040e8:	e8 13 01 00 00       	call   80104200 <initlock>
  lk->name = name;
...
80104121:	e8 4a 02 00 00       	call   80104370 <acquire>
  while (lk->locked) {
...
80104137:	e8 c4 fa ff ff       	call   80103c00 <sleep>
  while (lk->locked) {
...
80104142:	c7 03 01 00 00 00    	movl   $0x1,(%ebx)
  lk->pid = myproc()->pid;
80104148:	e8 53 f5 ff ff       	call   801036a0 <myproc>
...
8010415b:	5d                   	pop    %ebp
  release(&lk->lk);
8010415c:	e9 7f 02 00 00       	jmp    801043e0 <release>
...
80104181:	e8 ea 01 00 00       	call   80104370 <acquire>
  lk->locked = 0;
...
80104196:	e8 05 fd ff ff       	call   80103ea0 <wakeup>
  release(&lk->lk);
...
801041a3:	5d                   	pop    %ebp
  release(&lk->lk);
801041a4:	e9 37 02 00 00       	jmp    801043e0 <release>
...
801041b4:	31 ff                	xor    %edi,%edi
{
801041b6:	56                   	push   %esi
801041b7:	53                   	push   %ebx
801041b8:	83 ec 1c             	sub    $0x1c,%esp
801041bb:	8b 5d 08             	mov    0x8(%ebp),%ebx
  acquire(&lk->lk);
801041be:	8d 73 04             	lea    0x4(%ebx),%esi
801041c1:	89 34 24             	mov    %esi,(%esp)
801041c4:	e8 a7 01 00 00       	call   80104370 <acquire>
  r = lk->locked && (lk->pid == myproc()->pid);
801041c9:	8b 03                	mov    (%ebx),%eax
801041cb:	85 c0                	test   %eax,%eax
801041cd:	74 13                	je     801041e2 <holdingsleep+0x32>
801041cf:	8b 5b 3c             	mov    0x3c(%ebx),%ebx
801041d2:	e8 c9 f4 ff ff       	call   801036a0 <myproc>
801041d7:	3b 58 10             	cmp    0x10(%eax),%ebx
801041da:	0f 94 c0             	sete   %al
801041dd:	0f b6 c0             	movzbl %al,%eax
801041e0:	89 c7                	mov    %eax,%edi
  release(&lk->lk);
801041e2:	89 34 24             	mov    %esi,(%esp)
801041e5:	e8 f6 01 00 00       	call   801043e0 <release>
  return r;
}
801041ea:	83 c4 1c             	add    $0x1c,%esp
801041ed:	89 f8                	mov    %edi,%eax
801041ef:	5b                   	pop    %ebx
801041f0:	5e                   	pop    %esi
801041f1:	5f                   	pop    %edi
801041f2:	5d                   	pop    %ebp
801041f3:	c3                   	ret    
801041f4:	66 90                	xchg   %ax,%ax
...
80104299:	e8 62 f3 ff ff       	call   80103600 <mycpu>
8010429e:	81 e3 00 02 00 00    	and    $0x200,%ebx
801042a4:	89 98 a8 00 00 00    	mov    %ebx,0xa8(%eax)
  mycpu()->ncli += 1;
801042aa:	e8 51 f3 ff ff       	call   80103600 <mycpu>
...
801042cb:	75 49                	jne    80104316 <popcli+0x56>
  ...
  if(--mycpu()->ncli < 0)
801042cd:	e8 2e f3 ff ff       	call   80103600 <mycpu>
...
801042e5:	e8 16 f3 ff ff       	call   80103600 <mycpu>
...
80104309:	c3                   	ret    
    panic("popcli");
8010430a:	c7 04 24 86 75 10 80 	movl   $0x80107586,(%esp)
80104311:	e8 4a c0 ff ff       	call   80100360 <panic>
    panic("popcli - interruptible");
80104316:	c7 04 24 6f 75 10 80 	movl   $0x8010756f,(%esp)
...
80104334:	31 f6                	xor    %esi,%esi
{
80104336:	53                   	push   %ebx
80104337:	8b 5d 08             	mov    0x8(%ebp),%ebx
  pushcli();
8010433a:	e8 41 ff ff ff       	call   80104280 <pushcli>
  r = lock->locked && lock->cpu == mycpu();
8010433f:	8b 03                	mov    (%ebx),%eax
80104341:	85 c0                	test   %eax,%eax
80104343:	74 12                	je     80104357 <holding+0x27>
80104345:	8b 5b 08             	mov    0x8(%ebx),%ebx
80104348:	e8 b3 f2 ff ff       	call   80103600 <mycpu>
8010434d:	39 c3                	cmp    %eax,%ebx
8010434f:	0f 94 c0             	sete   %al
80104352:	0f b6 c0             	movzbl %al,%eax
80104355:	89 c6                	mov    %eax,%esi
  popcli();
80104357:	e8 64 ff ff ff       	call   801042c0 <popcli>
}
8010435c:	89 f0                	mov    %esi,%eax
8010435e:	5b                   	pop    %ebx
8010435f:	5e                   	pop    %esi
80104360:	5d                   	pop    %ebp
80104361:	c3                   	ret    
...
80104377:	e8 04 ff ff ff       	call   80104280 <pushcli>
  if(holding(lk))
8010437c:	8b 45 08             	mov    0x8(%ebp),%eax
8010437f:	89 04 24             	mov    %eax,(%esp)
80104382:	e8 a9 ff ff ff       	call   80104330 <holding>
80104387:	85 c0                	test   %eax,%eax
80104389:	75 3a                	jne    801043c5 <acquire+0x55>
  asm volatile("lock; xchgl %0, %1" :
8010438b:	b9 01 00 00 00       	mov    $0x1,%ecx
  while(xchg(&lk->locked, 1) != 0)
80104390:	8b 55 08             	mov    0x8(%ebp),%edx
80104393:	89 c8                	mov    %ecx,%eax
80104395:	f0 87 02             	lock xchg %eax,(%edx)
80104398:	85 c0                	test   %eax,%eax
8010439a:	75 f4                	jne    80104390 <acquire+0x20>
  __sync_synchronize();
8010439c:	0f ae f0             	mfence 
  lk->cpu = mycpu();
8010439f:	8b 5d 08             	mov    0x8(%ebp),%ebx
801043a2:	e8 59 f2 ff ff       	call   80103600 <mycpu>
801043a7:	89 43 08             	mov    %eax,0x8(%ebx)
  getcallerpcs(&lk, lk->pcs);
801043aa:	8b 45 08             	mov    0x8(%ebp),%eax
801043ad:	83 c0 0c             	add    $0xc,%eax
801043b0:	89 44 24 04          	mov    %eax,0x4(%esp)
801043b4:	8d 45 08             	lea    0x8(%ebp),%eax
801043b7:	89 04 24             	mov    %eax,(%esp)
801043ba:	e8 61 fe ff ff       	call   80104220 <getcallerpcs>
}
801043bf:	83 c4 14             	add    $0x14,%esp
801043c2:	5b                   	pop    %ebx
801043c3:	5d                   	pop    %ebp
801043c4:	c3                   	ret    
    panic("acquire");
801043c5:	c7 04 24 8d 75 10 80 	movl   $0x8010758d,(%esp)
801043cc:	e8 8f bf ff ff       	call   80100360 <panic>
...
801043ed:	e8 3e ff ff ff       	call   80104330 <holding>
801043f2:	85 c0                	test   %eax,%eax
801043f4:	74 21                	je     80104417 <release+0x37>
  lk->pcs[0] = 0;
801043f6:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
  lk->cpu = 0;
801043fd:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
  __sync_synchronize();
80104404:	0f ae f0             	mfence 
  asm volatile("movl $0, %0" : "+m" (lk->locked) : );
80104407:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
}
8010440d:	83 c4 14             	add    $0x14,%esp
80104410:	5b                   	pop    %ebx
80104411:	5d                   	pop    %ebp
  popcli();
80104412:	e9 a9 fe ff ff       	jmp    801042c0 <popcli>
    panic("release");
80104417:	c7 04 24 95 75 10 80 	movl   $0x80107595,(%esp)
8010441e:	e8 3d bf ff ff       	call   80100360 <panic>
80104423:	66 90                	xchg   %ax,%ax
...
80104483:	8b 45 10             	mov    0x10(%ebp),%eax
...
80104491:	8d 78 ff             	lea    -0x1(%eax),%edi
80104494:	74 26                	je     801044bc <memcmp+0x3c>
    if(*s1 != *s2)
80104496:	0f b6 03             	movzbl (%ebx),%eax
80104499:	31 d2                	xor    %edx,%edx
8010449b:	0f b6 0e             	movzbl (%esi),%ecx
8010449e:	38 c8                	cmp    %cl,%al
801044a0:	74 16                	je     801044b8 <memcmp+0x38>
801044a2:	eb 24                	jmp    801044c8 <memcmp+0x48>
801044a4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
801044a8:	0f b6 44 13 01       	movzbl 0x1(%ebx,%edx,1),%eax
801044ad:	83 c2 01             	add    $0x1,%edx
801044b0:	0f b6 0c 16          	movzbl (%esi,%edx,1),%ecx
801044b4:	38 c8                	cmp    %cl,%al
801044b6:	75 10                	jne    801044c8 <memcmp+0x48>
  while(n-- > 0){
801044b8:	39 fa                	cmp    %edi,%edx
...
801044dc:	8b 5d 10             	mov    0x10(%ebp),%ebx
  const char *s;
  char *d;
  ...
  d = dst;
  if(s < d && s + n > d){
801044df:	39 c6                	cmp    %eax,%esi
801044e1:	73 35                	jae    80104518 <memmove+0x48>
801044e3:	8d 0c 1e             	lea    (%esi,%ebx,1),%ecx
801044e6:	39 c8                	cmp    %ecx,%eax
801044e8:	73 2e                	jae    80104518 <memmove+0x48>
    s += n;
    d += n;
    while(n-- > 0)
801044ea:	85 db                	test   %ebx,%ebx
    d += n;
801044ec:	8d 3c 18             	lea    (%eax,%ebx,1),%edi
    while(n-- > 0)
801044ef:	8d 53 ff             	lea    -0x1(%ebx),%edx
801044f2:	74 1b                	je     8010450f <memmove+0x3f>
801044f4:	f7 db                	neg    %ebx
801044f6:	8d 34 19             	lea    (%ecx,%ebx,1),%esi
801044f9:	01 fb                	add    %edi,%ebx
801044fb:	90                   	nop
801044fc:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
      *--d = *--s;
80104500:	0f b6 0c 16          	movzbl (%esi,%edx,1),%ecx
80104504:	88 0c 13             	mov    %cl,(%ebx,%edx,1)
    while(n-- > 0)
80104507:	83 ea 01             	sub    $0x1,%edx
8010450a:	83 fa ff             	cmp    $0xffffffff,%edx
8010450d:	75 f1                	jne    80104500 <memmove+0x30>
  } else
    while(n-- > 0)
      *d++ = *s++;
...
8010451c:	74 f1                	je     8010450f <memmove+0x3f>
...
80104558:	8b 4d 08             	mov    0x8(%ebp),%ecx
8010455b:	8b 5d 0c             	mov    0xc(%ebp),%ebx
  while(n > 0 && *p && *p == *q)
8010455e:	85 f6                	test   %esi,%esi
80104560:	74 30                	je     80104592 <strncmp+0x42>
80104562:	0f b6 01             	movzbl (%ecx),%eax
80104565:	84 c0                	test   %al,%al
80104567:	74 2f                	je     80104598 <strncmp+0x48>
80104569:	0f b6 13             	movzbl (%ebx),%edx
8010456c:	38 d0                	cmp    %dl,%al
8010456e:	75 46                	jne    801045b6 <strncmp+0x66>
80104570:	8d 51 01             	lea    0x1(%ecx),%edx
80104573:	01 ce                	add    %ecx,%esi
80104575:	eb 14                	jmp    8010458b <strncmp+0x3b>
80104577:	90                   	nop
80104578:	0f b6 02             	movzbl (%edx),%eax
8010457b:	84 c0                	test   %al,%al
8010457d:	74 31                	je     801045b0 <strncmp+0x60>
8010457f:	0f b6 19             	movzbl (%ecx),%ebx
80104582:	83 c2 01             	add    $0x1,%edx
80104585:	38 d8                	cmp    %bl,%al
80104587:	75 17                	jne    801045a0 <strncmp+0x50>
    n--, p++, q++;
80104589:	89 cb                	mov    %ecx,%ebx
  while(n > 0 && *p && *p == *q)
8010458b:	39 f2                	cmp    %esi,%edx
    n--, p++, q++;
8010458d:	8d 4b 01             	lea    0x1(%ebx),%ecx
  while(n > 0 && *p && *p == *q)
...
80104596:	5d                   	pop    %ebp
80104597:	c3                   	ret    
80104598:	0f b6 1b             	movzbl (%ebx),%ebx
  while(n > 0 && *p && *p == *q)
8010459b:	31 c0                	xor    %eax,%eax
8010459d:	8d 76 00             	lea    0x0(%esi),%esi
  return (uchar)*p - (uchar)*q;
801045a0:	0f b6 d3             	movzbl %bl,%edx
...
801045b0:	0f b6 5b 01          	movzbl 0x1(%ebx),%ebx
801045b4:	eb ea                	jmp    801045a0 <strncmp+0x50>
  while(n > 0 && *p && *p == *q)
801045b6:	89 d3                	mov    %edx,%ebx
801045b8:	eb e6                	jmp    801045a0 <strncmp+0x50>
...
801045f6:	7e 0f                	jle    80104607 <strncpy+0x47>
    *s++ = 0;
801045f8:	c6 04 0a 00          	movb   $0x0,(%edx,%ecx,1)
801045fc:	89 f3                	mov    %esi,%ebx
801045fe:	83 c1 01             	add    $0x1,%ecx
80104601:	29 cb                	sub    %ecx,%ebx
  while(n-- > 0)
80104603:	85 db                	test   %ebx,%ebx
80104605:	7f f1                	jg     801045f8 <strncpy+0x38>
  return os;
}
80104607:	5b                   	pop    %ebx
80104608:	5e                   	pop    %esi
...
80104613:	8b 4d 10             	mov    0x10(%ebp),%ecx
...
80104687:	8b 5d 08             	mov    0x8(%ebp),%ebx
  struct proc *curproc = myproc();
8010468a:	e8 11 f0 ff ff       	call   801036a0 <myproc>
...
801046c7:	8b 5d 08             	mov    0x8(%ebp),%ebx
  char *s, *ep;
  struct proc *curproc = myproc();
801046ca:	e8 d1 ef ff ff       	call   801036a0 <myproc>

  if(addr >= curproc->sz)
801046cf:	39 18                	cmp    %ebx,(%eax)
801046d1:	76 26                	jbe    801046f9 <fetchstr+0x39>
    return -1;
  *pp = (char*)addr;
...
801046de:	73 19                	jae    801046f9 <fetchstr+0x39>
    if(*s == 0)
801046e0:	80 3b 00             	cmpb   $0x0,(%ebx)
801046e3:	75 0d                	jne    801046f2 <fetchstr+0x32>
801046e5:	eb 21                	jmp    80104708 <fetchstr+0x48>
801046e7:	90                   	nop
801046e8:	80 3a 00             	cmpb   $0x0,(%edx)
801046eb:	90                   	nop
801046ec:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
801046f0:	74 16                	je     80104708 <fetchstr+0x48>
  for(s = *pp; s < ep; s++){
801046f2:	83 c2 01             	add    $0x1,%edx
801046f5:	39 d0                	cmp    %edx,%eax
801046f7:	77 ef                	ja     801046e8 <fetchstr+0x28>
      return s - *pp;
  }
  return -1;
}
...
80104724:	8b 75 0c             	mov    0xc(%ebp),%esi
80104727:	53                   	push   %ebx
80104728:	8b 5d 08             	mov    0x8(%ebp),%ebx
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
8010472b:	e8 70 ef ff ff       	call   801036a0 <myproc>
80104730:	89 75 0c             	mov    %esi,0xc(%ebp)
80104733:	8b 40 18             	mov    0x18(%eax),%eax
80104736:	8b 40 44             	mov    0x44(%eax),%eax
80104739:	8d 44 98 04          	lea    0x4(%eax,%ebx,4),%eax
8010473d:	89 45 08             	mov    %eax,0x8(%ebp)
}
80104740:	5b                   	pop    %ebx
80104741:	5e                   	pop    %esi
80104742:	5d                   	pop    %ebp
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
80104743:	e9 38 ff ff ff       	jmp    80104680 <fetchint>
80104748:	90                   	nop
...
80104755:	83 ec 20             	sub    $0x20,%esp
80104758:	8b 5d 10             	mov    0x10(%ebp),%ebx
  int i;
  struct proc *curproc = myproc();
8010475b:	e8 40 ef ff ff       	call   801036a0 <myproc>
...
8010476f:	e8 ac ff ff ff       	call   80104720 <argint>
80104774:	85 c0                	test   %eax,%eax
80104776:	78 28                	js     801047a0 <argptr+0x50>
    return -1;
  if(size < 0 || (uint)i >= curproc->sz || (uint)i+size > curproc->sz)
80104778:	85 db                	test   %ebx,%ebx
8010477a:	78 24                	js     801047a0 <argptr+0x50>
8010477c:	8b 55 f4             	mov    -0xc(%ebp),%edx
8010477f:	8b 06                	mov    (%esi),%eax
80104781:	39 c2                	cmp    %eax,%edx
80104783:	73 1b                	jae    801047a0 <argptr+0x50>
80104785:	01 d3                	add    %edx,%ebx
80104787:	39 d8                	cmp    %ebx,%eax
80104789:	72 15                	jb     801047a0 <argptr+0x50>
    return -1;
  *pp = (char*)i;
...
801047b9:	89 44 24 04          	mov    %eax,0x4(%esp)
801047bd:	8b 45 08             	mov    0x8(%ebp),%eax
801047c0:	89 04 24             	mov    %eax,(%esp)
801047c3:	e8 58 ff ff ff       	call   80104720 <argint>
801047c8:	85 c0                	test   %eax,%eax
801047ca:	78 14                	js     801047e0 <argstr+0x30>
    return -1;
  return fetchstr(addr, pp);
801047cc:	8b 45 0c             	mov    0xc(%ebp),%eax
801047cf:	89 44 24 04          	mov    %eax,0x4(%esp)
801047d3:	8b 45 f4             	mov    -0xc(%ebp),%eax
801047d6:	89 04 24             	mov    %eax,(%esp)
801047d9:	e8 e2 fe ff ff       	call   801046c0 <fetchstr>
}
801047de:	c9                   	leave  
801047df:	c3                   	ret    
    return -1;
...
801047f5:	83 ec 10             	sub    $0x10,%esp
  int num;
  struct proc *curproc = myproc();
801047f8:	e8 a3 ee ff ff       	call   801036a0 <myproc>

  num = curproc->tf->eax;
801047fd:	8b 70 18             	mov    0x18(%eax),%esi
  struct proc *curproc = myproc();
80104800:	89 c3                	mov    %eax,%ebx
  num = curproc->tf->eax;
80104802:	8b 46 1c             	mov    0x1c(%esi),%eax
  if(num > 0 && num < NELEM(syscalls) && syscalls[num]) {
80104805:	8d 50 ff             	lea    -0x1(%eax),%edx
80104808:	83 fa 17             	cmp    $0x17,%edx
8010480b:	77 1b                	ja     80104828 <syscall+0x38>
8010480d:	8b 14 85 c0 75 10 80 	mov    -0x7fef8a40(,%eax,4),%edx
80104814:	85 d2                	test   %edx,%edx
80104816:	74 10                	je     80104828 <syscall+0x38>
    curproc->tf->eax = syscalls[num]();
80104818:	ff d2                	call   *%edx
8010481a:	89 46 1c             	mov    %eax,0x1c(%esi)
  } else {
...
8010482f:	89 44 24 08          	mov    %eax,0x8(%esp)
    cprintf("%d %s: unknown sys call %d\n",
80104833:	8b 43 10             	mov    0x10(%ebx),%eax
80104836:	c7 04 24 9d 75 10 80 	movl   $0x8010759d,(%esp)
8010483d:	89 44 24 04          	mov    %eax,0x4(%esp)
80104841:	e8 0a be ff ff       	call   80100650 <cprintf>
    curproc->tf->eax = -1;
80104846:	8b 43 18             	mov    0x18(%ebx),%eax
80104849:	c7 40 1c ff ff ff ff 	movl   $0xffffffff,0x1c(%eax)
}
...
80104864:	89 c3                	mov    %eax,%ebx
80104866:	83 ec 04             	sub    $0x4,%esp
  int fd;
  struct proc *curproc = myproc();
80104869:	e8 32 ee ff ff       	call   801036a0 <myproc>

  for(fd = 0; fd < NOFILE; fd++){
8010486e:	31 d2                	xor    %edx,%edx
    if(curproc->ofile[fd] == 0){
80104870:	8b 4c 90 28          	mov    0x28(%eax,%edx,4),%ecx
80104874:	85 c9                	test   %ecx,%ecx
80104876:	74 18                	je     80104890 <fdalloc+0x30>
  for(fd = 0; fd < NOFILE; fd++){
80104878:	83 c2 01             	add    $0x1,%edx
8010487b:	83 fa 10             	cmp    $0x10,%edx
8010487e:	75 f0                	jne    80104870 <fdalloc+0x10>
      curproc->ofile[fd] = f;
      return fd;
    }
  }
...
8010488c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
      curproc->ofile[fd] = f;
80104890:	89 5c 90 28          	mov    %ebx,0x28(%eax,%edx,4)
}
...
801048a6:	83 ec 3c             	sub    $0x3c,%esp
801048a9:	89 4d d0             	mov    %ecx,-0x30(%ebp)
801048ac:	8b 4d 08             	mov    0x8(%ebp),%ecx
  struct inode *ip, *dp;
  char name[DIRSIZ];

  if((dp = nameiparent(path, name)) == 0)
801048af:	8d 5d da             	lea    -0x26(%ebp),%ebx
801048b2:	89 5c 24 04          	mov    %ebx,0x4(%esp)
801048b6:	89 04 24             	mov    %eax,(%esp)
{
801048b9:	89 55 d4             	mov    %edx,-0x2c(%ebp)
801048bc:	89 4d cc             	mov    %ecx,-0x34(%ebp)
  if((dp = nameiparent(path, name)) == 0)
801048bf:	e8 5c d6 ff ff       	call   80101f20 <nameiparent>
801048c4:	85 c0                	test   %eax,%eax
801048c6:	89 c7                	mov    %eax,%edi
801048c8:	0f 84 da 00 00 00    	je     801049a8 <create+0x108>
    return 0;
  ilock(dp);
801048ce:	89 04 24             	mov    %eax,(%esp)
801048d1:	e8 da cd ff ff       	call   801016b0 <ilock>

  if((ip = dirlookup(dp, name, 0)) != 0){
801048d6:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
801048dd:	00 
801048de:	89 5c 24 04          	mov    %ebx,0x4(%esp)
801048e2:	89 3c 24             	mov    %edi,(%esp)
801048e5:	e8 d6 d2 ff ff       	call   80101bc0 <dirlookup>
801048ea:	85 c0                	test   %eax,%eax
801048ec:	89 c6                	mov    %eax,%esi
801048ee:	74 40                	je     80104930 <create+0x90>
    iunlockput(dp);
801048f0:	89 3c 24             	mov    %edi,(%esp)
801048f3:	e8 18 d0 ff ff       	call   80101910 <iunlockput>
    ilock(ip);
801048f8:	89 34 24             	mov    %esi,(%esp)
801048fb:	e8 b0 cd ff ff       	call   801016b0 <ilock>
    if(type == T_FILE && ip->type == T_FILE)
80104900:	66 83 7d d4 02       	cmpw   $0x2,-0x2c(%ebp)
80104905:	75 11                	jne    80104918 <create+0x78>
80104907:	66 83 7e 50 02       	cmpw   $0x2,0x50(%esi)
8010490c:	89 f0                	mov    %esi,%eax
8010490e:	75 08                	jne    80104918 <create+0x78>
...
8010491b:	e8 f0 cf ff ff       	call   80101910 <iunlockput>
}
80104920:	83 c4 3c             	add    $0x3c,%esp
    return 0;
...
80104934:	89 44 24 04          	mov    %eax,0x4(%esp)
80104938:	8b 07                	mov    (%edi),%eax
8010493a:	89 04 24             	mov    %eax,(%esp)
8010493d:	e8 de cb ff ff       	call   80101520 <ialloc>
80104942:	85 c0                	test   %eax,%eax
80104944:	89 c6                	mov    %eax,%esi
80104946:	0f 84 bf 00 00 00    	je     80104a0b <create+0x16b>
  ilock(ip);
8010494c:	89 04 24             	mov    %eax,(%esp)
8010494f:	e8 5c cd ff ff       	call   801016b0 <ilock>
  ip->major = major;
80104954:	0f b7 45 d0          	movzwl -0x30(%ebp),%eax
80104958:	66 89 46 52          	mov    %ax,0x52(%esi)
  ip->minor = minor;
8010495c:	0f b7 45 cc          	movzwl -0x34(%ebp),%eax
80104960:	66 89 46 54          	mov    %ax,0x54(%esi)
  ip->nlink = 1;
80104964:	b8 01 00 00 00       	mov    $0x1,%eax
80104969:	66 89 46 56          	mov    %ax,0x56(%esi)
  iupdate(ip);
8010496d:	89 34 24             	mov    %esi,(%esp)
80104970:	e8 7b cc ff ff       	call   801015f0 <iupdate>
  if(type == T_DIR){  // Create . and .. entries.
80104975:	66 83 7d d4 01       	cmpw   $0x1,-0x2c(%ebp)
8010497a:	74 34                	je     801049b0 <create+0x110>
  if(dirlink(dp, name, ip->inum) < 0)
8010497c:	8b 46 04             	mov    0x4(%esi),%eax
8010497f:	89 5c 24 04          	mov    %ebx,0x4(%esp)
...
80104991:	78 6c                	js     801049ff <create+0x15f>
  iunlockput(dp);
80104993:	89 3c 24             	mov    %edi,(%esp)
80104996:	e8 75 cf ff ff       	call   80101910 <iunlockput>
}
8010499b:	83 c4 3c             	add    $0x3c,%esp
  return ip;
...
801049aa:	e9 61 ff ff ff       	jmp    80104910 <create+0x70>
801049af:	90                   	nop
    dp->nlink++;  // for ".."
801049b0:	66 83 47 56 01       	addw   $0x1,0x56(%edi)
    iupdate(dp);
801049b5:	89 3c 24             	mov    %edi,(%esp)
801049b8:	e8 33 cc ff ff       	call   801015f0 <iupdate>
    if(dirlink(ip, ".", ip->inum) < 0 || dirlink(ip, "..", dp->inum) < 0)
801049bd:	8b 46 04             	mov    0x4(%esi),%eax
801049c0:	c7 44 24 04 40 76 10 	movl   $0x80107640,0x4(%esp)
801049c7:	80 
801049c8:	89 34 24             	mov    %esi,(%esp)
801049cb:	89 44 24 08          	mov    %eax,0x8(%esp)
801049cf:	e8 4c d4 ff ff       	call   80101e20 <dirlink>
801049d4:	85 c0                	test   %eax,%eax
801049d6:	78 1b                	js     801049f3 <create+0x153>
801049d8:	8b 47 04             	mov    0x4(%edi),%eax
801049db:	c7 44 24 04 3f 76 10 	movl   $0x8010763f,0x4(%esp)
801049e2:	80 
801049e3:	89 34 24             	mov    %esi,(%esp)
801049e6:	89 44 24 08          	mov    %eax,0x8(%esp)
801049ea:	e8 31 d4 ff ff       	call   80101e20 <dirlink>
801049ef:	85 c0                	test   %eax,%eax
801049f1:	79 89                	jns    8010497c <create+0xdc>
      panic("create dots");
801049f3:	c7 04 24 33 76 10 80 	movl   $0x80107633,(%esp)
801049fa:	e8 61 b9 ff ff       	call   80100360 <panic>
    panic("create: dirlink");
801049ff:	c7 04 24 42 76 10 80 	movl   $0x80107642,(%esp)
80104a06:	e8 55 b9 ff ff       	call   80100360 <panic>
    panic("create: ialloc");
80104a0b:	c7 04 24 24 76 10 80 	movl   $0x80107624,(%esp)
80104a12:	e8 49 b9 ff ff       	call   80100360 <panic>
...
80104a27:	89 d3                	mov    %edx,%ebx
80104a29:	83 ec 20             	sub    $0x20,%esp
  if(argint(n, &fd) < 0)
80104a2c:	8d 45 f4             	lea    -0xc(%ebp),%eax
80104a2f:	89 44 24 04          	mov    %eax,0x4(%esp)
80104a33:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80104a3a:	e8 e1 fc ff ff       	call   80104720 <argint>
80104a3f:	85 c0                	test   %eax,%eax
80104a41:	78 2d                	js     80104a70 <argfd.constprop.0+0x50>
  if(fd < 0 || fd >= NOFILE || (f=myproc()->ofile[fd]) == 0)
80104a43:	83 7d f4 0f          	cmpl   $0xf,-0xc(%ebp)
80104a47:	77 27                	ja     80104a70 <argfd.constprop.0+0x50>
80104a49:	e8 52 ec ff ff       	call   801036a0 <myproc>
80104a4e:	8b 55 f4             	mov    -0xc(%ebp),%edx
80104a51:	8b 44 90 28          	mov    0x28(%eax,%edx,4),%eax
80104a55:	85 c0                	test   %eax,%eax
80104a57:	74 17                	je     80104a70 <argfd.constprop.0+0x50>
  if(pfd)
80104a59:	85 f6                	test   %esi,%esi
80104a5b:	74 02                	je     80104a5f <argfd.constprop.0+0x3f>
    *pfd = fd;
80104a5d:	89 16                	mov    %edx,(%esi)
  if(pf)
80104a5f:	85 db                	test   %ebx,%ebx
80104a61:	74 1d                	je     80104a80 <argfd.constprop.0+0x60>
    *pf = f;
80104a63:	89 03                	mov    %eax,(%ebx)
  return 0;
80104a65:	31 c0                	xor    %eax,%eax
}
80104a67:	83 c4 20             	add    $0x20,%esp
80104a6a:	5b                   	pop    %ebx
80104a6b:	5e                   	pop    %esi
80104a6c:	5d                   	pop    %ebp
80104a6d:	c3                   	ret    
...
80104a82:	eb e3                	jmp    80104a67 <argfd.constprop.0+0x47>
...
80104a96:	83 ec 24             	sub    $0x24,%esp
  if(argfd(0, 0, &f) < 0)
80104a99:	8d 55 f4             	lea    -0xc(%ebp),%edx
80104a9c:	e8 7f ff ff ff       	call   80104a20 <argfd.constprop.0>
80104aa1:	85 c0                	test   %eax,%eax
80104aa3:	78 23                	js     80104ac8 <sys_dup+0x38>
  if((fd=fdalloc(f)) < 0)
80104aa5:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104aa8:	e8 b3 fd ff ff       	call   80104860 <fdalloc>
80104aad:	85 c0                	test   %eax,%eax
80104aaf:	89 c3                	mov    %eax,%ebx
80104ab1:	78 15                	js     80104ac8 <sys_dup+0x38>
  filedup(f);
80104ab3:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104ab6:	89 04 24             	mov    %eax,(%esp)
80104ab9:	e8 22 c3 ff ff       	call   80100de0 <filedup>
  return fd;
80104abe:	89 d8                	mov    %ebx,%eax
}
80104ac0:	83 c4 24             	add    $0x24,%esp
80104ac3:	5b                   	pop    %ebx
80104ac4:	5d                   	pop    %ebp
80104ac5:	c3                   	ret    
...
80104acd:	eb f1                	jmp    80104ac0 <sys_dup+0x30>
80104acf:	90                   	nop
...
80104adb:	e8 40 ff ff ff       	call   80104a20 <argfd.constprop.0>
80104ae0:	85 c0                	test   %eax,%eax
80104ae2:	78 54                	js     80104b38 <sys_read+0x68>
80104ae4:	8d 45 f0             	lea    -0x10(%ebp),%eax
80104ae7:	89 44 24 04          	mov    %eax,0x4(%esp)
80104aeb:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
80104af2:	e8 29 fc ff ff       	call   80104720 <argint>
80104af7:	85 c0                	test   %eax,%eax
80104af9:	78 3d                	js     80104b38 <sys_read+0x68>
...
80104b10:	e8 3b fc ff ff       	call   80104750 <argptr>
80104b15:	85 c0                	test   %eax,%eax
80104b17:	78 1f                	js     80104b38 <sys_read+0x68>
...
80104b4b:	e8 d0 fe ff ff       	call   80104a20 <argfd.constprop.0>
80104b50:	85 c0                	test   %eax,%eax
80104b52:	78 54                	js     80104ba8 <sys_write+0x68>
80104b54:	8d 45 f0             	lea    -0x10(%ebp),%eax
80104b57:	89 44 24 04          	mov    %eax,0x4(%esp)
80104b5b:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
80104b62:	e8 b9 fb ff ff       	call   80104720 <argint>
80104b67:	85 c0                	test   %eax,%eax
80104b69:	78 3d                	js     80104ba8 <sys_write+0x68>
...
80104b80:	e8 cb fb ff ff       	call   80104750 <argptr>
80104b85:	85 c0                	test   %eax,%eax
80104b87:	78 1f                	js     80104ba8 <sys_write+0x68>
...
80104bb3:	83 ec 28             	sub    $0x28,%esp
  if(argfd(0, &fd, &f) < 0)
80104bb6:	8d 55 f4             	lea    -0xc(%ebp),%edx
80104bb9:	8d 45 f0             	lea    -0x10(%ebp),%eax
80104bbc:	e8 5f fe ff ff       	call   80104a20 <argfd.constprop.0>
80104bc1:	85 c0                	test   %eax,%eax
80104bc3:	78 23                	js     80104be8 <sys_close+0x38>
  myproc()->ofile[fd] = 0;
80104bc5:	e8 d6 ea ff ff       	call   801036a0 <myproc>
80104bca:	8b 55 f0             	mov    -0x10(%ebp),%edx
80104bcd:	c7 44 90 28 00 00 00 	movl   $0x0,0x28(%eax,%edx,4)
80104bd4:	00 
  fileclose(f);
...
80104bfb:	e8 20 fe ff ff       	call   80104a20 <argfd.constprop.0>
80104c00:	85 c0                	test   %eax,%eax
80104c02:	78 34                	js     80104c38 <sys_fstat+0x48>
80104c04:	8d 45 f4             	lea    -0xc(%ebp),%eax
80104c07:	c7 44 24 08 14 00 00 	movl   $0x14,0x8(%esp)
80104c0e:	00 
80104c0f:	89 44 24 04          	mov    %eax,0x4(%esp)
80104c13:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80104c1a:	e8 31 fb ff ff       	call   80104750 <argptr>
80104c1f:	85 c0                	test   %eax,%eax
80104c21:	78 15                	js     80104c38 <sys_fstat+0x48>
...
80104c30:	e8 bb c2 ff ff       	call   80100ef0 <filestat>
}
80104c35:	c9                   	leave  
80104c36:	c3                   	ret    
80104c37:	90                   	nop
...
80104cb7:	e8 34 c9 ff ff       	call   801015f0 <iupdate>
  iunlock(ip);
80104cbc:	89 1c 24             	mov    %ebx,(%esp)
80104cbf:	e8 cc ca ff ff       	call   80101790 <iunlock>
  if((dp = nameiparent(new, name)) == 0)
80104cc4:	8b 45 d0             	mov    -0x30(%ebp),%eax
80104cc7:	89 7c 24 04          	mov    %edi,0x4(%esp)
80104ccb:	89 04 24             	mov    %eax,(%esp)
80104cce:	e8 4d d2 ff ff       	call   80101f20 <nameiparent>
80104cd3:	85 c0                	test   %eax,%eax
80104cd5:	89 c6                	mov    %eax,%esi
80104cd7:	74 4f                	je     80104d28 <sys_link+0xe8>
  ilock(dp);
80104cd9:	89 04 24             	mov    %eax,(%esp)
80104cdc:	e8 cf c9 ff ff       	call   801016b0 <ilock>
  if(dp->dev != ip->dev || dirlink(dp, name, ip->inum) < 0){
80104ce1:	8b 03                	mov    (%ebx),%eax
80104ce3:	39 06                	cmp    %eax,(%esi)
80104ce5:	75 39                	jne    80104d20 <sys_link+0xe0>
80104ce7:	8b 43 04             	mov    0x4(%ebx),%eax
80104cea:	89 7c 24 04          	mov    %edi,0x4(%esp)
80104cee:	89 34 24             	mov    %esi,(%esp)
80104cf1:	89 44 24 08          	mov    %eax,0x8(%esp)
80104cf5:	e8 26 d1 ff ff       	call   80101e20 <dirlink>
80104cfa:	85 c0                	test   %eax,%eax
80104cfc:	78 22                	js     80104d20 <sys_link+0xe0>
  iunlockput(dp);
80104cfe:	89 34 24             	mov    %esi,(%esp)
80104d01:	e8 0a cc ff ff       	call   80101910 <iunlockput>
  iput(ip);
80104d06:	89 1c 24             	mov    %ebx,(%esp)
80104d09:	e8 c2 ca ff ff       	call   801017d0 <iput>
  end_op();
80104d0e:	e8 6d de ff ff       	call   80102b80 <end_op>
}
80104d13:	83 c4 3c             	add    $0x3c,%esp
  return 0;
80104d16:	31 c0                	xor    %eax,%eax
}
80104d18:	5b                   	pop    %ebx
80104d19:	5e                   	pop    %esi
80104d1a:	5f                   	pop    %edi
...
80104d4a:	83 c4 3c             	add    $0x3c,%esp
  return -1;
...
80104d66:	83 ec 5c             	sub    $0x5c,%esp
  if(argstr(0, &path) < 0)
80104d69:	8d 45 c0             	lea    -0x40(%ebp),%eax
80104d6c:	89 44 24 04          	mov    %eax,0x4(%esp)
80104d70:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80104d77:	e8 34 fa ff ff       	call   801047b0 <argstr>
80104d7c:	85 c0                	test   %eax,%eax
80104d7e:	0f 88 76 01 00 00    	js     80104efa <sys_unlink+0x19a>
  begin_op();
80104d84:	e8 87 dd ff ff       	call   80102b10 <begin_op>
  if((dp = nameiparent(path, name)) == 0){
80104d89:	8b 45 c0             	mov    -0x40(%ebp),%eax
80104d8c:	8d 5d ca             	lea    -0x36(%ebp),%ebx
80104d8f:	89 5c 24 04          	mov    %ebx,0x4(%esp)
80104d93:	89 04 24             	mov    %eax,(%esp)
80104d96:	e8 85 d1 ff ff       	call   80101f20 <nameiparent>
80104d9b:	85 c0                	test   %eax,%eax
80104d9d:	89 45 b4             	mov    %eax,-0x4c(%ebp)
80104da0:	0f 84 4f 01 00 00    	je     80104ef5 <sys_unlink+0x195>
  ilock(dp);
80104da6:	8b 75 b4             	mov    -0x4c(%ebp),%esi
80104da9:	89 34 24             	mov    %esi,(%esp)
80104dac:	e8 ff c8 ff ff       	call   801016b0 <ilock>
  if(namecmp(name, ".") == 0 || namecmp(name, "..") == 0)
80104db1:	c7 44 24 04 40 76 10 	movl   $0x80107640,0x4(%esp)
80104db8:	80 
80104db9:	89 1c 24             	mov    %ebx,(%esp)
80104dbc:	e8 cf cd ff ff       	call   80101b90 <namecmp>
80104dc1:	85 c0                	test   %eax,%eax
80104dc3:	0f 84 21 01 00 00    	je     80104eea <sys_unlink+0x18a>
80104dc9:	c7 44 24 04 3f 76 10 	movl   $0x8010763f,0x4(%esp)
80104dd0:	80 
80104dd1:	89 1c 24             	mov    %ebx,(%esp)
80104dd4:	e8 b7 cd ff ff       	call   80101b90 <namecmp>
80104dd9:	85 c0                	test   %eax,%eax
80104ddb:	0f 84 09 01 00 00    	je     80104eea <sys_unlink+0x18a>
  if((ip = dirlookup(dp, name, &off)) == 0)
80104de1:	8d 45 c4             	lea    -0x3c(%ebp),%eax
80104de4:	89 5c 24 04          	mov    %ebx,0x4(%esp)
80104de8:	89 44 24 08          	mov    %eax,0x8(%esp)
80104dec:	89 34 24             	mov    %esi,(%esp)
80104def:	e8 cc cd ff ff       	call   80101bc0 <dirlookup>
80104df4:	85 c0                	test   %eax,%eax
80104df6:	89 c3                	mov    %eax,%ebx
80104df8:	0f 84 ec 00 00 00    	je     80104eea <sys_unlink+0x18a>
  ilock(ip);
80104dfe:	89 04 24             	mov    %eax,(%esp)
80104e01:	e8 aa c8 ff ff       	call   801016b0 <ilock>
  if(ip->nlink < 1)
80104e06:	66 83 7b 56 00       	cmpw   $0x0,0x56(%ebx)
80104e0b:	0f 8e 24 01 00 00    	jle    80104f35 <sys_unlink+0x1d5>
  if(ip->type == T_DIR && !isdirempty(ip)){
80104e11:	66 83 7b 50 01       	cmpw   $0x1,0x50(%ebx)
80104e16:	8d 75 d8             	lea    -0x28(%ebp),%esi
80104e19:	74 7d                	je     80104e98 <sys_unlink+0x138>
  memset(&de, 0, sizeof(de));
80104e1b:	c7 44 24 08 10 00 00 	movl   $0x10,0x8(%esp)
80104e22:	00 
80104e23:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80104e2a:	00 
80104e2b:	89 34 24             	mov    %esi,(%esp)
80104e2e:	e8 fd f5 ff ff       	call   80104430 <memset>
  if(writei(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
80104e33:	8b 45 c4             	mov    -0x3c(%ebp),%eax
80104e36:	c7 44 24 0c 10 00 00 	movl   $0x10,0xc(%esp)
80104e3d:	00 
80104e3e:	89 74 24 04          	mov    %esi,0x4(%esp)
80104e42:	89 44 24 08          	mov    %eax,0x8(%esp)
80104e46:	8b 45 b4             	mov    -0x4c(%ebp),%eax
80104e49:	89 04 24             	mov    %eax,(%esp)
80104e4c:	e8 0f cc ff ff       	call   80101a60 <writei>
80104e51:	83 f8 10             	cmp    $0x10,%eax
80104e54:	0f 85 cf 00 00 00    	jne    80104f29 <sys_unlink+0x1c9>
  if(ip->type == T_DIR){
80104e5a:	66 83 7b 50 01       	cmpw   $0x1,0x50(%ebx)
80104e5f:	0f 84 a3 00 00 00    	je     80104f08 <sys_unlink+0x1a8>
  iunlockput(dp);
80104e65:	8b 45 b4             	mov    -0x4c(%ebp),%eax
...
80104e98:	83 7b 58 20          	cmpl   $0x20,0x58(%ebx)
80104e9c:	0f 86 79 ff ff ff    	jbe    80104e1b <sys_unlink+0xbb>
80104ea2:	bf 20 00 00 00       	mov    $0x20,%edi
80104ea7:	eb 15                	jmp    80104ebe <sys_unlink+0x15e>
80104ea9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
80104eb0:	8d 57 10             	lea    0x10(%edi),%edx
80104eb3:	3b 53 58             	cmp    0x58(%ebx),%edx
80104eb6:	0f 83 5f ff ff ff    	jae    80104e1b <sys_unlink+0xbb>
80104ebc:	89 d7                	mov    %edx,%edi
    if(readi(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
80104ebe:	c7 44 24 0c 10 00 00 	movl   $0x10,0xc(%esp)
80104ec5:	00 
80104ec6:	89 7c 24 08          	mov    %edi,0x8(%esp)
80104eca:	89 74 24 04          	mov    %esi,0x4(%esp)
80104ece:	89 1c 24             	mov    %ebx,(%esp)
80104ed1:	e8 8a ca ff ff       	call   80101960 <readi>
80104ed6:	83 f8 10             	cmp    $0x10,%eax
80104ed9:	75 42                	jne    80104f1d <sys_unlink+0x1bd>
    if(de.inum != 0)
80104edb:	66 83 7d d8 00       	cmpw   $0x0,-0x28(%ebp)
80104ee0:	74 ce                	je     80104eb0 <sys_unlink+0x150>
    iunlockput(ip);
80104ee2:	89 1c 24             	mov    %ebx,(%esp)
80104ee5:	e8 26 ca ff ff       	call   80101910 <iunlockput>
  iunlockput(dp);
80104eea:	8b 45 b4             	mov    -0x4c(%ebp),%eax
...
80104f0b:	66 83 68 56 01       	subw   $0x1,0x56(%eax)
    iupdate(dp);
80104f10:	89 04 24             	mov    %eax,(%esp)
80104f13:	e8 d8 c6 ff ff       	call   801015f0 <iupdate>
80104f18:	e9 48 ff ff ff       	jmp    80104e65 <sys_unlink+0x105>
      panic("isdirempty: readi");
80104f1d:	c7 04 24 64 76 10 80 	movl   $0x80107664,(%esp)
80104f24:	e8 37 b4 ff ff       	call   80100360 <panic>
    panic("unlink: writei");
80104f29:	c7 04 24 76 76 10 80 	movl   $0x80107676,(%esp)
80104f30:	e8 2b b4 ff ff       	call   80100360 <panic>
    panic("unlink: nlink < 1");
80104f35:	c7 04 24 52 76 10 80 	movl   $0x80107652,(%esp)
80104f3c:	e8 1f b4 ff ff       	call   80100360 <panic>
80104f41:	eb 0d                	jmp    80104f50 <sys_open>
80104f43:	90                   	nop
80104f44:	90                   	nop
80104f45:	90                   	nop
80104f46:	90                   	nop
...
80104f56:	83 ec 2c             	sub    $0x2c,%esp
  char *path;
  int fd, omode;
  struct file *f;
  struct inode *ip;
...
80104f59:	8d 45 e0             	lea    -0x20(%ebp),%eax
80104f5c:	89 44 24 04          	mov    %eax,0x4(%esp)
80104f60:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80104f67:	e8 44 f8 ff ff       	call   801047b0 <argstr>
80104f6c:	85 c0                	test   %eax,%eax
80104f6e:	0f 88 d1 00 00 00    	js     80105045 <sys_open+0xf5>
80104f74:	8d 45 e4             	lea    -0x1c(%ebp),%eax
80104f77:	89 44 24 04          	mov    %eax,0x4(%esp)
80104f7b:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80104f82:	e8 99 f7 ff ff       	call   80104720 <argint>
80104f87:	85 c0                	test   %eax,%eax
80104f89:	0f 88 b6 00 00 00    	js     80105045 <sys_open+0xf5>
    return -1;

  begin_op();
80104f8f:	e8 7c db ff ff       	call   80102b10 <begin_op>

  if(omode & O_CREATE){
80104f94:	f6 45 e5 02          	testb  $0x2,-0x1b(%ebp)
80104f98:	0f 85 82 00 00 00    	jne    80105020 <sys_open+0xd0>
    if(ip == 0){
      end_op();
      return -1;
    }
...
80104fa4:	e8 57 cf ff ff       	call   80101f00 <namei>
80104fa9:	85 c0                	test   %eax,%eax
80104fab:	89 c6                	mov    %eax,%esi
80104fad:	0f 84 8d 00 00 00    	je     80105040 <sys_open+0xf0>
      end_op();
      return -1;
    }
    ilock(ip);
...
80104fbb:	66 83 7e 50 01       	cmpw   $0x1,0x50(%esi)
80104fc0:	0f 84 92 00 00 00    	je     80105058 <sys_open+0x108>
      end_op();
      return -1;
    }
  }
...
80104fc6:	e8 a5 bd ff ff       	call   80100d70 <filealloc>
80104fcb:	85 c0                	test   %eax,%eax
80104fcd:	89 c3                	mov    %eax,%ebx
80104fcf:	0f 84 93 00 00 00    	je     80105068 <sys_open+0x118>
80104fd5:	e8 86 f8 ff ff       	call   80104860 <fdalloc>
80104fda:	85 c0                	test   %eax,%eax
80104fdc:	89 c7                	mov    %eax,%edi
80104fde:	0f 88 94 00 00 00    	js     80105078 <sys_open+0x128>
      fileclose(f);
    iunlockput(ip);
    end_op();
    return -1;
  ...
  iunlock(ip);
80104fe4:	89 34 24             	mov    %esi,(%esp)
80104fe7:	e8 a4 c7 ff ff       	call   80101790 <iunlock>
  end_op();
80104fec:	e8 8f db ff ff       	call   80102b80 <end_op>

  f->type = FD_INODE;
80104ff1:	c7 03 02 00 00 00    	movl   $0x2,(%ebx)
  f->ip = ip;
  f->off = 0;
  f->readable = !(omode & O_WRONLY);
80104ff7:	8b 45 e4             	mov    -0x1c(%ebp),%eax
  f->ip = ip;
80104ffa:	89 73 10             	mov    %esi,0x10(%ebx)
  f->off = 0;
80104ffd:	c7 43 14 00 00 00 00 	movl   $0x0,0x14(%ebx)
  f->readable = !(omode & O_WRONLY);
80105004:	89 c2                	mov    %eax,%edx
80105006:	83 e2 01             	and    $0x1,%edx
80105009:	83 f2 01             	xor    $0x1,%edx
  f->writable = (omode & O_WRONLY) || (omode & O_RDWR);
8010500c:	a8 03                	test   $0x3,%al
  f->readable = !(omode & O_WRONLY);
8010500e:	88 53 08             	mov    %dl,0x8(%ebx)
  return fd;
80105011:	89 f8                	mov    %edi,%eax
  f->writable = (omode & O_WRONLY) || (omode & O_RDWR);
80105013:	0f 95 43 09          	setne  0x9(%ebx)
}
80105017:	83 c4 2c             	add    $0x2c,%esp
8010501a:	5b                   	pop    %ebx
8010501b:	5e                   	pop    %esi
8010501c:	5f                   	pop    %edi
8010501d:	5d                   	pop    %ebp
...
80105023:	31 c9                	xor    %ecx,%ecx
80105025:	ba 02 00 00 00       	mov    $0x2,%edx
8010502a:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105031:	e8 6a f8 ff ff       	call   801048a0 <create>
    if(ip == 0){
80105036:	85 c0                	test   %eax,%eax
    ip = create(path, T_FILE, 0, 0);
80105038:	89 c6                	mov    %eax,%esi
    if(ip == 0){
8010503a:	75 8a                	jne    80104fc6 <sys_open+0x76>
...
8010505d:	0f 84 63 ff ff ff    	je     80104fc6 <sys_open+0x76>
80105063:	90                   	nop
80105064:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    iunlockput(ip);
80105068:	89 34 24             	mov    %esi,(%esp)
8010506b:	e8 a0 c8 ff ff       	call   80101910 <iunlockput>
80105070:	eb ce                	jmp    80105040 <sys_open+0xf0>
80105072:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      fileclose(f);
80105078:	89 1c 24             	mov    %ebx,(%esp)
8010507b:	e8 b0 bd ff ff       	call   80100e30 <fileclose>
80105080:	eb e6                	jmp    80105068 <sys_open+0x118>
...
801050a9:	e8 02 f7 ff ff       	call   801047b0 <argstr>
801050ae:	85 c0                	test   %eax,%eax
801050b0:	78 2e                	js     801050e0 <sys_mkdir+0x50>
801050b2:	8b 45 f4             	mov    -0xc(%ebp),%eax
801050b5:	31 c9                	xor    %ecx,%ecx
801050b7:	ba 01 00 00 00       	mov    $0x1,%edx
801050bc:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
801050c3:	e8 d8 f7 ff ff       	call   801048a0 <create>
801050c8:	85 c0                	test   %eax,%eax
801050ca:	74 14                	je     801050e0 <sys_mkdir+0x50>
    end_op();
    return -1;
  }
  iunlockput(ip);
...
80105109:	e8 a2 f6 ff ff       	call   801047b0 <argstr>
8010510e:	85 c0                	test   %eax,%eax
80105110:	78 5e                	js     80105170 <sys_mknod+0x80>
     argint(1, &major) < 0 ||
80105112:	8d 45 f0             	lea    -0x10(%ebp),%eax
80105115:	89 44 24 04          	mov    %eax,0x4(%esp)
80105119:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80105120:	e8 fb f5 ff ff       	call   80104720 <argint>
  if((argstr(0, &path)) < 0 ||
80105125:	85 c0                	test   %eax,%eax
80105127:	78 47                	js     80105170 <sys_mknod+0x80>
     argint(2, &minor) < 0 ||
80105129:	8d 45 f4             	lea    -0xc(%ebp),%eax
8010512c:	89 44 24 04          	mov    %eax,0x4(%esp)
80105130:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
80105137:	e8 e4 f5 ff ff       	call   80104720 <argint>
     argint(1, &major) < 0 ||
8010513c:	85 c0                	test   %eax,%eax
8010513e:	78 30                	js     80105170 <sys_mknod+0x80>
     (ip = create(path, T_DEV, major, minor)) == 0){
80105140:	0f bf 45 f4          	movswl -0xc(%ebp),%eax
     argint(2, &minor) < 0 ||
80105144:	ba 03 00 00 00       	mov    $0x3,%edx
     (ip = create(path, T_DEV, major, minor)) == 0){
80105149:	0f bf 4d f0          	movswl -0x10(%ebp),%ecx
8010514d:	89 04 24             	mov    %eax,(%esp)
     argint(2, &minor) < 0 ||
80105150:	8b 45 ec             	mov    -0x14(%ebp),%eax
80105153:	e8 48 f7 ff ff       	call   801048a0 <create>
80105158:	85 c0                	test   %eax,%eax
8010515a:	74 14                	je     80105170 <sys_mknod+0x80>
    end_op();
    return -1;
  }
  iunlockput(ip);
...
80105185:	83 ec 20             	sub    $0x20,%esp
  char *path;
  struct inode *ip;
  struct proc *curproc = myproc();
80105188:	e8 13 e5 ff ff       	call   801036a0 <myproc>
8010518d:	89 c6                	mov    %eax,%esi
  
  begin_op();
8010518f:	e8 7c d9 ff ff       	call   80102b10 <begin_op>
  if(argstr(0, &path) < 0 || (ip = namei(path)) == 0){
80105194:	8d 45 f4             	lea    -0xc(%ebp),%eax
80105197:	89 44 24 04          	mov    %eax,0x4(%esp)
8010519b:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
801051a2:	e8 09 f6 ff ff       	call   801047b0 <argstr>
801051a7:	85 c0                	test   %eax,%eax
801051a9:	78 4a                	js     801051f5 <sys_chdir+0x75>
801051ab:	8b 45 f4             	mov    -0xc(%ebp),%eax
801051ae:	89 04 24             	mov    %eax,(%esp)
801051b1:	e8 4a cd ff ff       	call   80101f00 <namei>
801051b6:	85 c0                	test   %eax,%eax
801051b8:	89 c3                	mov    %eax,%ebx
801051ba:	74 39                	je     801051f5 <sys_chdir+0x75>
    end_op();
    return -1;
  }
  ilock(ip);
801051bc:	89 04 24             	mov    %eax,(%esp)
801051bf:	e8 ec c4 ff ff       	call   801016b0 <ilock>
  if(ip->type != T_DIR){
801051c4:	66 83 7b 50 01       	cmpw   $0x1,0x50(%ebx)
    iunlockput(ip);
801051c9:	89 1c 24             	mov    %ebx,(%esp)
  if(ip->type != T_DIR){
801051cc:	75 22                	jne    801051f0 <sys_chdir+0x70>
    end_op();
    return -1;
  }
  iunlock(ip);
801051ce:	e8 bd c5 ff ff       	call   80101790 <iunlock>
  iput(curproc->cwd);
801051d3:	8b 46 68             	mov    0x68(%esi),%eax
801051d6:	89 04 24             	mov    %eax,(%esp)
801051d9:	e8 f2 c5 ff ff       	call   801017d0 <iput>
  end_op();
801051de:	e8 9d d9 ff ff       	call   80102b80 <end_op>
  curproc->cwd = ip;
  return 0;
801051e3:	31 c0                	xor    %eax,%eax
  curproc->cwd = ip;
801051e5:	89 5e 68             	mov    %ebx,0x68(%esi)
}
801051e8:	83 c4 20             	add    $0x20,%esp
801051eb:	5b                   	pop    %ebx
801051ec:	5e                   	pop    %esi
801051ed:	5d                   	pop    %ebp
801051ee:	c3                   	ret    
801051ef:	90                   	nop
    iunlockput(ip);
801051f0:	e8 1b c7 ff ff       	call   80101910 <iunlockput>
    end_op();
801051f5:	e8 86 d9 ff ff       	call   80102b80 <end_op>
}
801051fa:	83 c4 20             	add    $0x20,%esp
    return -1;
...
80105216:	81 ec ac 00 00 00    	sub    $0xac,%esp
  char *path, *argv[MAXARG];
  int i;
  uint uargv, uarg;

  if(argstr(0, &path) < 0 || argint(1, (int*)&uargv) < 0){
8010521c:	8d 85 5c ff ff ff    	lea    -0xa4(%ebp),%eax
...
80105234:	0f 88 84 00 00 00    	js     801052be <sys_exec+0xae>
8010523a:	8d 85 60 ff ff ff    	lea    -0xa0(%ebp),%eax
80105240:	89 44 24 04          	mov    %eax,0x4(%esp)
80105244:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
8010524b:	e8 d0 f4 ff ff       	call   80104720 <argint>
80105250:	85 c0                	test   %eax,%eax
80105252:	78 6a                	js     801052be <sys_exec+0xae>
    return -1;
  }
  memset(argv, 0, sizeof(argv));
80105254:	8d 85 68 ff ff ff    	lea    -0x98(%ebp),%eax
  for(i=0;; i++){
8010525a:	31 db                	xor    %ebx,%ebx
  memset(argv, 0, sizeof(argv));
8010525c:	c7 44 24 08 80 00 00 	movl   $0x80,0x8(%esp)
80105263:	00 
80105264:	8d b5 68 ff ff ff    	lea    -0x98(%ebp),%esi
8010526a:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80105271:	00 
80105272:	8d bd 64 ff ff ff    	lea    -0x9c(%ebp),%edi
80105278:	89 04 24             	mov    %eax,(%esp)
8010527b:	e8 b0 f1 ff ff       	call   80104430 <memset>
    if(i >= NELEM(argv))
      return -1;
    if(fetchint(uargv+4*i, (int*)&uarg) < 0)
80105280:	8b 85 60 ff ff ff    	mov    -0xa0(%ebp),%eax
80105286:	89 7c 24 04          	mov    %edi,0x4(%esp)
8010528a:	8d 04 98             	lea    (%eax,%ebx,4),%eax
8010528d:	89 04 24             	mov    %eax,(%esp)
80105290:	e8 eb f3 ff ff       	call   80104680 <fetchint>
80105295:	85 c0                	test   %eax,%eax
80105297:	78 25                	js     801052be <sys_exec+0xae>
      return -1;
    if(uarg == 0){
80105299:	8b 85 64 ff ff ff    	mov    -0x9c(%ebp),%eax
8010529f:	85 c0                	test   %eax,%eax
801052a1:	74 2d                	je     801052d0 <sys_exec+0xc0>
      argv[i] = 0;
      break;
    }
    if(fetchstr(uarg, &argv[i]) < 0)
801052a3:	89 74 24 04          	mov    %esi,0x4(%esp)
801052a7:	89 04 24             	mov    %eax,(%esp)
801052aa:	e8 11 f4 ff ff       	call   801046c0 <fetchstr>
801052af:	85 c0                	test   %eax,%eax
801052b1:	78 0b                	js     801052be <sys_exec+0xae>
  for(i=0;; i++){
801052b3:	83 c3 01             	add    $0x1,%ebx
801052b6:	83 c6 04             	add    $0x4,%esi
    if(i >= NELEM(argv))
801052b9:	83 fb 20             	cmp    $0x20,%ebx
801052bc:	75 c2                	jne    80105280 <sys_exec+0x70>
      return -1;
  }
  return exec(path, argv);
}
801052be:	81 c4 ac 00 00 00    	add    $0xac,%esp
    return -1;
...
801052da:	8b 85 5c ff ff ff    	mov    -0xa4(%ebp),%eax
      argv[i] = 0;
801052e0:	c7 84 9d 68 ff ff ff 	movl   $0x0,-0x98(%ebp,%ebx,4)
801052e7:	00 00 00 00 
  return exec(path, argv);
801052eb:	89 04 24             	mov    %eax,(%esp)
801052ee:	e8 ad b6 ff ff       	call   801009a0 <exec>
}
801052f3:	81 c4 ac 00 00 00    	add    $0xac,%esp
801052f9:	5b                   	pop    %ebx
801052fa:	5e                   	pop    %esi
801052fb:	5f                   	pop    %edi
801052fc:	5d                   	pop    %ebp
...
8010530a:	c7 44 24 08 08 00 00 	movl   $0x8,0x8(%esp)
80105311:	00 
80105312:	89 44 24 04          	mov    %eax,0x4(%esp)
80105316:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
8010531d:	e8 2e f4 ff ff       	call   80104750 <argptr>
80105322:	85 c0                	test   %eax,%eax
80105324:	78 6d                	js     80105393 <sys_pipe+0x93>
    return -1;
  if(pipealloc(&rf, &wf) < 0)
80105326:	8d 45 f4             	lea    -0xc(%ebp),%eax
80105329:	89 44 24 04          	mov    %eax,0x4(%esp)
8010532d:	8d 45 f0             	lea    -0x10(%ebp),%eax
80105330:	89 04 24             	mov    %eax,(%esp)
80105333:	e8 38 de ff ff       	call   80103170 <pipealloc>
80105338:	85 c0                	test   %eax,%eax
8010533a:	78 57                	js     80105393 <sys_pipe+0x93>
    return -1;
  fd0 = -1;
  if((fd0 = fdalloc(rf)) < 0 || (fd1 = fdalloc(wf)) < 0){
8010533c:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010533f:	e8 1c f5 ff ff       	call   80104860 <fdalloc>
80105344:	85 c0                	test   %eax,%eax
80105346:	89 c3                	mov    %eax,%ebx
80105348:	78 33                	js     8010537d <sys_pipe+0x7d>
8010534a:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010534d:	e8 0e f5 ff ff       	call   80104860 <fdalloc>
80105352:	85 c0                	test   %eax,%eax
80105354:	78 1a                	js     80105370 <sys_pipe+0x70>
      myproc()->ofile[fd0] = 0;
    fileclose(rf);
    fileclose(wf);
    return -1;
  ...
  fd[0] = fd0;
80105356:	8b 55 ec             	mov    -0x14(%ebp),%edx
80105359:	89 1a                	mov    %ebx,(%edx)
  fd[1] = fd1;
8010535b:	8b 55 ec             	mov    -0x14(%ebp),%edx
8010535e:	89 42 04             	mov    %eax,0x4(%edx)
  return 0;
}
80105361:	83 c4 24             	add    $0x24,%esp
  return 0;
...
80105375:	c7 44 98 28 00 00 00 	movl   $0x0,0x28(%eax,%ebx,4)
8010537c:	00 
    fileclose(rf);
8010537d:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105380:	89 04 24             	mov    %eax,(%esp)
80105383:	e8 a8 ba ff ff       	call   80100e30 <fileclose>
    fileclose(wf);
80105388:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010538b:	89 04 24             	mov    %eax,(%esp)
8010538e:	e8 9d ba ff ff       	call   80100e30 <fileclose>
}
80105393:	83 c4 24             	add    $0x24,%esp
    return -1;
...
801053a3:	5d                   	pop    %ebp
  return fork();
801053a4:	e9 a7 e4 ff ff       	jmp    80103850 <fork>
801053a9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi

801053b0 <sys_exit>:

int //modified in lab1
sys_exit(void)
{
...
801053c4:	e8 57 f3 ff ff       	call   80104720 <argint>
801053c9:	85 c0                	test   %eax,%eax
801053cb:	78 13                	js     801053e0 <sys_exit+0x30>
    return -1;
  }
  exit(status);
801053cd:	8b 45 f4             	mov    -0xc(%ebp),%eax
801053d0:	89 04 24             	mov    %eax,(%esp)
801053d3:	e8 c8 e6 ff ff       	call   80103aa0 <exit>
...
801053f9:	c7 44 24 08 04 00 00 	movl   $0x4,0x8(%esp)
80105400:	00 
80105401:	89 44 24 04          	mov    %eax,0x4(%esp)
80105405:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
8010540c:	e8 3f f3 ff ff       	call   80104750 <argptr>
80105411:	85 c0                	test   %eax,%eax
80105413:	78 13                	js     80105428 <sys_wait+0x38>
    return -1;
  }
  return wait(status);
80105415:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105418:	89 04 24             	mov    %eax,(%esp)
8010541b:	e8 90 e8 ff ff       	call   80103cb0 <wait>
}
80105420:	c9                   	leave  
80105421:	c3                   	ret    
...
80105433:	83 ec 28             	sub    $0x28,%esp
  ...
  if(argint(0, &pid) < 0){
80105436:	8d 45 ec             	lea    -0x14(%ebp),%eax
80105439:	89 44 24 04          	mov    %eax,0x4(%esp)
8010543d:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105444:	e8 d7 f2 ff ff       	call   80104720 <argint>
80105449:	85 c0                	test   %eax,%eax
8010544b:	78 53                	js     801054a0 <sys_waitpid+0x70>
    return -1;
  }

  if(argptr(1, (void*)&status, sizeof(*status)) < 0){
8010544d:	8d 45 f0             	lea    -0x10(%ebp),%eax
80105450:	c7 44 24 08 04 00 00 	movl   $0x4,0x8(%esp)
80105457:	00 
80105458:	89 44 24 04          	mov    %eax,0x4(%esp)
8010545c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80105463:	e8 e8 f2 ff ff       	call   80104750 <argptr>
80105468:	85 c0                	test   %eax,%eax
8010546a:	78 34                	js     801054a0 <sys_waitpid+0x70>
    return -1;
  }
...
80105473:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
8010547a:	e8 a1 f2 ff ff       	call   80104720 <argint>
8010547f:	85 c0                	test   %eax,%eax
80105481:	78 1d                	js     801054a0 <sys_waitpid+0x70>
    return -1;
  }

  return waitpid(pid, status, options);
80105483:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105486:	89 44 24 08          	mov    %eax,0x8(%esp)
8010548a:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010548d:	89 44 24 04          	mov    %eax,0x4(%esp)
80105491:	8b 45 ec             	mov    -0x14(%ebp),%eax
80105494:	89 04 24             	mov    %eax,(%esp)
80105497:	e8 04 e9 ff ff       	call   80103da0 <waitpid>
}
8010549c:	c9                   	leave  
8010549d:	c3                   	ret    
...
801054c4:	e8 57 f2 ff ff       	call   80104720 <argint>
801054c9:	85 c0                	test   %eax,%eax
801054cb:	78 13                	js     801054e0 <sys_kill+0x30>
    return -1;
  return kill(pid);
801054cd:	8b 45 f4             	mov    -0xc(%ebp),%eax
801054d0:	89 04 24             	mov    %eax,(%esp)
801054d3:	e8 28 ea ff ff       	call   80103f00 <kill>
}
801054d8:	c9                   	leave  
801054d9:	c3                   	ret    
...
801054f3:	83 ec 08             	sub    $0x8,%esp
  return myproc()->pid;
801054f6:	e8 a5 e1 ff ff       	call   801036a0 <myproc>
...
80105515:	e8 06 f2 ff ff       	call   80104720 <argint>
8010551a:	85 c0                	test   %eax,%eax
8010551c:	78 22                	js     80105540 <sys_sbrk+0x40>
    return -1;
  addr = myproc()->sz;
8010551e:	e8 7d e1 ff ff       	call   801036a0 <myproc>
  if(growproc(n) < 0)
80105523:	8b 55 f4             	mov    -0xc(%ebp),%edx
  addr = myproc()->sz;
80105526:	8b 18                	mov    (%eax),%ebx
  if(growproc(n) < 0)
80105528:	89 14 24             	mov    %edx,(%esp)
8010552b:	e8 b0 e2 ff ff       	call   801037e0 <growproc>
80105530:	85 c0                	test   %eax,%eax
80105532:	78 0c                	js     80105540 <sys_sbrk+0x40>
    return -1;
  return addr;
80105534:	89 d8                	mov    %ebx,%eax
}
80105536:	83 c4 24             	add    $0x24,%esp
80105539:	5b                   	pop    %ebx
8010553a:	5d                   	pop    %ebp
8010553b:	c3                   	ret    
...
80105545:	eb ef                	jmp    80105536 <sys_sbrk+0x36>
...
80105565:	e8 b6 f1 ff ff       	call   80104720 <argint>
8010556a:	85 c0                	test   %eax,%eax
8010556c:	78 7e                	js     801055ec <sys_sleep+0x9c>
    return -1;
  acquire(&tickslock);
8010556e:	c7 04 24 60 4d 11 80 	movl   $0x80114d60,(%esp)
80105575:	e8 f6 ed ff ff       	call   80104370 <acquire>
  ticks0 = ticks;
  while(ticks - ticks0 < n){
8010557a:	8b 55 f4             	mov    -0xc(%ebp),%edx
  ticks0 = ticks;
8010557d:	8b 1d a0 55 11 80    	mov    0x801155a0,%ebx
  while(ticks - ticks0 < n){
80105583:	85 d2                	test   %edx,%edx
80105585:	75 29                	jne    801055b0 <sys_sleep+0x60>
80105587:	eb 4f                	jmp    801055d8 <sys_sleep+0x88>
...
80105590:	c7 44 24 04 60 4d 11 	movl   $0x80114d60,0x4(%esp)
80105597:	80 
80105598:	c7 04 24 a0 55 11 80 	movl   $0x801155a0,(%esp)
8010559f:	e8 5c e6 ff ff       	call   80103c00 <sleep>
  while(ticks - ticks0 < n){
801055a4:	a1 a0 55 11 80       	mov    0x801155a0,%eax
801055a9:	29 d8                	sub    %ebx,%eax
801055ab:	3b 45 f4             	cmp    -0xc(%ebp),%eax
801055ae:	73 28                	jae    801055d8 <sys_sleep+0x88>
    if(myproc()->killed){
801055b0:	e8 eb e0 ff ff       	call   801036a0 <myproc>
801055b5:	8b 40 24             	mov    0x24(%eax),%eax
801055b8:	85 c0                	test   %eax,%eax
801055ba:	74 d4                	je     80105590 <sys_sleep+0x40>
      release(&tickslock);
801055bc:	c7 04 24 60 4d 11 80 	movl   $0x80114d60,(%esp)
801055c3:	e8 18 ee ff ff       	call   801043e0 <release>
      return -1;
...
801055cd:	83 c4 24             	add    $0x24,%esp
801055d0:	5b                   	pop    %ebx
801055d1:	5d                   	pop    %ebp
801055d2:	c3                   	ret    
801055d3:	90                   	nop
801055d4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  release(&tickslock);
801055d8:	c7 04 24 60 4d 11 80 	movl   $0x80114d60,(%esp)
801055df:	e8 fc ed ff ff       	call   801043e0 <release>
}
801055e4:	83 c4 24             	add    $0x24,%esp
  return 0;
...
801055f1:	eb da                	jmp    801055cd <sys_sleep+0x7d>
...
80105604:	83 ec 14             	sub    $0x14,%esp
  uint xticks;

  acquire(&tickslock);
80105607:	c7 04 24 60 4d 11 80 	movl   $0x80114d60,(%esp)
8010560e:	e8 5d ed ff ff       	call   80104370 <acquire>
  xticks = ticks;
80105613:	8b 1d a0 55 11 80    	mov    0x801155a0,%ebx
  release(&tickslock);
80105619:	c7 04 24 60 4d 11 80 	movl   $0x80114d60,(%esp)
80105620:	e8 bb ed ff ff       	call   801043e0 <release>
  return xticks;
}
80105625:	83 c4 14             	add    $0x14,%esp
80105628:	89 d8                	mov    %ebx,%eax
8010562a:	5b                   	pop    %ebx
8010562b:	5d                   	pop    %ebp
8010562c:	c3                   	ret    
...
80105631:	b8 e5 07 00 00       	mov    $0x7e5,%eax
{
...
//  exit(0);
  debug();
80105646:	e8 05 ea ff ff       	call   80104050 <debug>
  return 0;
  //return myproc();
}
...
80105650:	06                   	push   %es
  pushl %fs
80105651:	0f a0                	push   %fs
  pushl %gs
80105653:	0f a8                	push   %gs
  pushal
80105655:	60                   	pusha  
  
  # Set up data segments.
  movw $(SEG_KDATA<<3), %ax
80105656:	66 b8 10 00          	mov    $0x10,%ax
  movw %ax, %ds
8010565a:	8e d8                	mov    %eax,%ds
  movw %ax, %es
8010565c:	8e c0                	mov    %eax,%es

  # Call trap(tf), where tf=%esp
  pushl %esp
8010565e:	54                   	push   %esp
  call trap
8010565f:	e8 ec 00 00 00       	call   80105750 <trap>
  addl $4, %esp
80105664:	83 c4 04             	add    $0x4,%esp
...
80105667:	61                   	popa   
  popl %gs
80105668:	0f a9                	pop    %gs
  popl %fs
8010566a:	0f a1                	pop    %fs
  popl %es
8010566c:	07                   	pop    %es
  popl %ds
8010566d:	1f                   	pop    %ds
...
80105694:	66 89 0c c5 a2 4d 11 	mov    %cx,-0x7feeb25e(,%eax,8)
8010569b:	80 
8010569c:	c6 04 c5 a4 4d 11 80 	movb   $0x0,-0x7feeb25c(,%eax,8)
801056a3:	00 
...
801056d9:	c7 44 24 04 85 76 10 	movl   $0x80107685,0x4(%esp)
801056e0:	80 
801056e1:	c7 04 24 60 4d 11 80 	movl   $0x80114d60,(%esp)
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
801056e8:	66 89 15 a2 4f 11 80 	mov    %dx,0x80114fa2
801056ef:	66 a3 a0 4f 11 80    	mov    %ax,0x80114fa0
801056f5:	c1 e8 10             	shr    $0x10,%eax
801056f8:	c6 05 a4 4f 11 80 00 	movb   $0x0,0x80114fa4
801056ff:	c6 05 a5 4f 11 80 ef 	movb   $0xef,0x80114fa5
80105706:	66 a3 a6 4f 11 80    	mov    %ax,0x80114fa6
  initlock(&tickslock, "time");
8010570c:	e8 ef ea ff ff       	call   80104200 <initlock>
}
80105711:	c9                   	leave  
80105712:	c3                   	ret    
...
80105770:	ff 24 85 2c 77 10 80 	jmp    *-0x7fef88d4(,%eax,4)
80105777:	90                   	nop
    lapiceoi();
    break;
...
80105778:	e8 23 df ff ff       	call   801036a0 <myproc>
...
8010579c:	e8 df de ff ff       	call   80103680 <cpuid>
...
801057ac:	e8 ef de ff ff       	call   801036a0 <myproc>
...
801057e3:	c7 04 24 e8 76 10 80 	movl   $0x801076e8,(%esp)
801057ea:	89 44 24 04          	mov    %eax,0x4(%esp)
801057ee:	e8 5d ae ff ff       	call   80100650 <cprintf>
            tf->err, cpuid(), tf->eip, rcr2());
    myproc()->killed = 1;
801057f3:	e8 a8 de ff ff       	call   801036a0 <myproc>
...
80105809:	e8 92 de ff ff       	call   801036a0 <myproc>
...
80105815:	e8 86 de ff ff       	call   801036a0 <myproc>
...
80105829:	74 55                	je     80105880 <trap+0x130>
  ...
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
8010582b:	e8 70 de ff ff       	call   801036a0 <myproc>
...
80105874:	e8 27 e2 ff ff       	call   80103aa0 <exit>
...
80105884:	75 a5                	jne    8010582b <trap+0xdb>
    yield();
80105886:	e8 35 e3 ff ff       	call   80103bc0 <yield>
8010588b:	eb 9e                	jmp    8010582b <trap+0xdb>
8010588d:	8d 76 00             	lea    0x0(%esi),%esi
    if(cpuid() == 0){
80105890:	e8 eb dd ff ff       	call   80103680 <cpuid>
...
801058d7:	e8 a4 dd ff ff       	call   80103680 <cpuid>
801058dc:	c7 04 24 90 76 10 80 	movl   $0x80107690,(%esp)
...
80105909:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    if(myproc()->killed)
80105910:	e8 8b dd ff ff       	call   801036a0 <myproc>
...
80105921:	89 58 18             	mov    %ebx,0x18(%eax)
    syscall();
80105924:	e8 c7 ee ff ff       	call   801047f0 <syscall>
    if(myproc()->killed)
80105929:	e8 72 dd ff ff       	call   801036a0 <myproc>
...
80105946:	5d                   	pop    %ebp
      exit(0);
80105947:	e9 54 e1 ff ff       	jmp    80103aa0 <exit>
...
80105967:	e8 04 ea ff ff       	call   80104370 <acquire>
      wakeup(&ticks);
8010596c:	c7 04 24 a0 55 11 80 	movl   $0x801155a0,(%esp)
      ticks++;
80105973:	83 05 a0 55 11 80 01 	addl   $0x1,0x801155a0
      wakeup(&ticks);
8010597a:	e8 21 e5 ff ff       	call   80103ea0 <wakeup>
      release(&tickslock);
8010597f:	c7 04 24 60 4d 11 80 	movl   $0x80114d60,(%esp)
80105986:	e8 55 ea ff ff       	call   801043e0 <release>
...
801059aa:	c7 04 24 b4 76 10 80 	movl   $0x801076b4,(%esp)
801059b1:	89 44 24 04          	mov    %eax,0x4(%esp)
801059b5:	e8 96 ac ff ff       	call   80100650 <cprintf>
      panic("trap");
801059ba:	c7 04 24 8a 76 10 80 	movl   $0x8010768a,(%esp)
...
80105ab7:	00 
  for(p="xv6...\n"; *p; p++)
80105ab8:	bb ac 77 10 80       	mov    $0x801077ac,%ebx
  ioapicenable(IRQ_COM1, 0);
...
80105b06:	6a 00                	push   $0x0
  jmp alltraps
80105b08:	e9 42 fb ff ff       	jmp    8010564f <alltraps>
...
80105b0f:	6a 01                	push   $0x1
  jmp alltraps
80105b11:	e9 39 fb ff ff       	jmp    8010564f <alltraps>
...
80105b18:	6a 02                	push   $0x2
  jmp alltraps
80105b1a:	e9 30 fb ff ff       	jmp    8010564f <alltraps>
...
80105b21:	6a 03                	push   $0x3
  jmp alltraps
80105b23:	e9 27 fb ff ff       	jmp    8010564f <alltraps>
...
80105b2a:	6a 04                	push   $0x4
  jmp alltraps
80105b2c:	e9 1e fb ff ff       	jmp    8010564f <alltraps>
...
80105b33:	6a 05                	push   $0x5
  jmp alltraps
80105b35:	e9 15 fb ff ff       	jmp    8010564f <alltraps>
...
80105b3c:	6a 06                	push   $0x6
  jmp alltraps
80105b3e:	e9 0c fb ff ff       	jmp    8010564f <alltraps>
...
80105b45:	6a 07                	push   $0x7
  jmp alltraps
80105b47:	e9 03 fb ff ff       	jmp    8010564f <alltraps>
...
80105b4c:	6a 08                	push   $0x8
  jmp alltraps
80105b4e:	e9 fc fa ff ff       	jmp    8010564f <alltraps>
...
80105b55:	6a 09                	push   $0x9
  jmp alltraps
80105b57:	e9 f3 fa ff ff       	jmp    8010564f <alltraps>
...
80105b5c:	6a 0a                	push   $0xa
  jmp alltraps
80105b5e:	e9 ec fa ff ff       	jmp    8010564f <alltraps>
...
80105b63:	6a 0b                	push   $0xb
  jmp alltraps
80105b65:	e9 e5 fa ff ff       	jmp    8010564f <alltraps>
...
80105b6a:	6a 0c                	push   $0xc
  jmp alltraps
80105b6c:	e9 de fa ff ff       	jmp    8010564f <alltraps>
...
80105b71:	6a 0d                	push   $0xd
  jmp alltraps
80105b73:	e9 d7 fa ff ff       	jmp    8010564f <alltraps>
...
80105b78:	6a 0e                	push   $0xe
  jmp alltraps
80105b7a:	e9 d0 fa ff ff       	jmp    8010564f <alltraps>
...
80105b81:	6a 0f                	push   $0xf
  jmp alltraps
80105b83:	e9 c7 fa ff ff       	jmp    8010564f <alltraps>
...
80105b8a:	6a 10                	push   $0x10
  jmp alltraps
80105b8c:	e9 be fa ff ff       	jmp    8010564f <alltraps>
...
80105b91:	6a 11                	push   $0x11
  jmp alltraps
80105b93:	e9 b7 fa ff ff       	jmp    8010564f <alltraps>
...
80105b9a:	6a 12                	push   $0x12
  jmp alltraps
80105b9c:	e9 ae fa ff ff       	jmp    8010564f <alltraps>
...
80105ba3:	6a 13                	push   $0x13
  jmp alltraps
80105ba5:	e9 a5 fa ff ff       	jmp    8010564f <alltraps>
...
80105bac:	6a 14                	push   $0x14
  jmp alltraps
80105bae:	e9 9c fa ff ff       	jmp    8010564f <alltraps>
...
80105bb5:	6a 15                	push   $0x15
  jmp alltraps
80105bb7:	e9 93 fa ff ff       	jmp    8010564f <alltraps>
...
80105bbe:	6a 16                	push   $0x16
  jmp alltraps
80105bc0:	e9 8a fa ff ff       	jmp    8010564f <alltraps>
...
80105bc7:	6a 17                	push   $0x17
  jmp alltraps
80105bc9:	e9 81 fa ff ff       	jmp    8010564f <alltraps>
...
80105bd0:	6a 18                	push   $0x18
  jmp alltraps
80105bd2:	e9 78 fa ff ff       	jmp    8010564f <alltraps>
...
80105bd9:	6a 19                	push   $0x19
  jmp alltraps
80105bdb:	e9 6f fa ff ff       	jmp    8010564f <alltraps>
...
80105be2:	6a 1a                	push   $0x1a
  jmp alltraps
80105be4:	e9 66 fa ff ff       	jmp    8010564f <alltraps>
...
80105beb:	6a 1b                	push   $0x1b
  jmp alltraps
80105bed:	e9 5d fa ff ff       	jmp    8010564f <alltraps>
...
80105bf4:	6a 1c                	push   $0x1c
  jmp alltraps
80105bf6:	e9 54 fa ff ff       	jmp    8010564f <alltraps>
...
80105bfd:	6a 1d                	push   $0x1d
  jmp alltraps
80105bff:	e9 4b fa ff ff       	jmp    8010564f <alltraps>
...
80105c06:	6a 1e                	push   $0x1e
  jmp alltraps
80105c08:	e9 42 fa ff ff       	jmp    8010564f <alltraps>
...
80105c0f:	6a 1f                	push   $0x1f
  jmp alltraps
80105c11:	e9 39 fa ff ff       	jmp    8010564f <alltraps>
...
80105c18:	6a 20                	push   $0x20
  jmp alltraps
80105c1a:	e9 30 fa ff ff       	jmp    8010564f <alltraps>
...
80105c21:	6a 21                	push   $0x21
  jmp alltraps
80105c23:	e9 27 fa ff ff       	jmp    8010564f <alltraps>
...
80105c2a:	6a 22                	push   $0x22
  jmp alltraps
80105c2c:	e9 1e fa ff ff       	jmp    8010564f <alltraps>
...
80105c33:	6a 23                	push   $0x23
  jmp alltraps
80105c35:	e9 15 fa ff ff       	jmp    8010564f <alltraps>
...
80105c3c:	6a 24                	push   $0x24
  jmp alltraps
80105c3e:	e9 0c fa ff ff       	jmp    8010564f <alltraps>
...
80105c45:	6a 25                	push   $0x25
  jmp alltraps
80105c47:	e9 03 fa ff ff       	jmp    8010564f <alltraps>
...
80105c4e:	6a 26                	push   $0x26
  jmp alltraps
80105c50:	e9 fa f9 ff ff       	jmp    8010564f <alltraps>
...
80105c57:	6a 27                	push   $0x27
  jmp alltraps
80105c59:	e9 f1 f9 ff ff       	jmp    8010564f <alltraps>
...
80105c60:	6a 28                	push   $0x28
  jmp alltraps
80105c62:	e9 e8 f9 ff ff       	jmp    8010564f <alltraps>
...
80105c69:	6a 29                	push   $0x29
  jmp alltraps
80105c6b:	e9 df f9 ff ff       	jmp    8010564f <alltraps>
...
80105c72:	6a 2a                	push   $0x2a
  jmp alltraps
80105c74:	e9 d6 f9 ff ff       	jmp    8010564f <alltraps>
...
80105c7b:	6a 2b                	push   $0x2b
  jmp alltraps
80105c7d:	e9 cd f9 ff ff       	jmp    8010564f <alltraps>
...
80105c84:	6a 2c                	push   $0x2c
  jmp alltraps
80105c86:	e9 c4 f9 ff ff       	jmp    8010564f <alltraps>
...
80105c8d:	6a 2d                	push   $0x2d
  jmp alltraps
80105c8f:	e9 bb f9 ff ff       	jmp    8010564f <alltraps>
...
80105c96:	6a 2e                	push   $0x2e
  jmp alltraps
80105c98:	e9 b2 f9 ff ff       	jmp    8010564f <alltraps>
...
80105c9f:	6a 2f                	push   $0x2f
  jmp alltraps
80105ca1:	e9 a9 f9 ff ff       	jmp    8010564f <alltraps>
...
80105ca8:	6a 30                	push   $0x30
  jmp alltraps
80105caa:	e9 a0 f9 ff ff       	jmp    8010564f <alltraps>
...
80105cb1:	6a 31                	push   $0x31
  jmp alltraps
80105cb3:	e9 97 f9 ff ff       	jmp    8010564f <alltraps>
...
80105cba:	6a 32                	push   $0x32
  jmp alltraps
80105cbc:	e9 8e f9 ff ff       	jmp    8010564f <alltraps>
...
80105cc3:	6a 33                	push   $0x33
  jmp alltraps
80105cc5:	e9 85 f9 ff ff       	jmp    8010564f <alltraps>
...
80105ccc:	6a 34                	push   $0x34
  jmp alltraps
80105cce:	e9 7c f9 ff ff       	jmp    8010564f <alltraps>
...
80105cd5:	6a 35                	push   $0x35
  jmp alltraps
80105cd7:	e9 73 f9 ff ff       	jmp    8010564f <alltraps>
...
80105cde:	6a 36                	push   $0x36
  jmp alltraps
80105ce0:	e9 6a f9 ff ff       	jmp    8010564f <alltraps>
...
80105ce7:	6a 37                	push   $0x37
  jmp alltraps
80105ce9:	e9 61 f9 ff ff       	jmp    8010564f <alltraps>
...
80105cf0:	6a 38                	push   $0x38
  jmp alltraps
80105cf2:	e9 58 f9 ff ff       	jmp    8010564f <alltraps>
...
80105cf9:	6a 39                	push   $0x39
  jmp alltraps
80105cfb:	e9 4f f9 ff ff       	jmp    8010564f <alltraps>
...
80105d02:	6a 3a                	push   $0x3a
  jmp alltraps
80105d04:	e9 46 f9 ff ff       	jmp    8010564f <alltraps>
...
80105d0b:	6a 3b                	push   $0x3b
  jmp alltraps
80105d0d:	e9 3d f9 ff ff       	jmp    8010564f <alltraps>
...
80105d14:	6a 3c                	push   $0x3c
  jmp alltraps
80105d16:	e9 34 f9 ff ff       	jmp    8010564f <alltraps>
...
80105d1d:	6a 3d                	push   $0x3d
  jmp alltraps
80105d1f:	e9 2b f9 ff ff       	jmp    8010564f <alltraps>
...
80105d26:	6a 3e                	push   $0x3e
  jmp alltraps
80105d28:	e9 22 f9 ff ff       	jmp    8010564f <alltraps>
...
80105d2f:	6a 3f                	push   $0x3f
  jmp alltraps
80105d31:	e9 19 f9 ff ff       	jmp    8010564f <alltraps>
...
80105d38:	6a 40                	push   $0x40
  jmp alltraps
80105d3a:	e9 10 f9 ff ff       	jmp    8010564f <alltraps>
...
80105d41:	6a 41                	push   $0x41
  jmp alltraps
80105d43:	e9 07 f9 ff ff       	jmp    8010564f <alltraps>
...
80105d4a:	6a 42                	push   $0x42
  jmp alltraps
80105d4c:	e9 fe f8 ff ff       	jmp    8010564f <alltraps>
...
80105d53:	6a 43                	push   $0x43
  jmp alltraps
80105d55:	e9 f5 f8 ff ff       	jmp    8010564f <alltraps>
...
80105d5c:	6a 44                	push   $0x44
  jmp alltraps
80105d5e:	e9 ec f8 ff ff       	jmp    8010564f <alltraps>
...
80105d65:	6a 45                	push   $0x45
  jmp alltraps
80105d67:	e9 e3 f8 ff ff       	jmp    8010564f <alltraps>
...
80105d6e:	6a 46                	push   $0x46
  jmp alltraps
80105d70:	e9 da f8 ff ff       	jmp    8010564f <alltraps>
...
80105d77:	6a 47                	push   $0x47
  jmp alltraps
80105d79:	e9 d1 f8 ff ff       	jmp    8010564f <alltraps>
...
80105d80:	6a 48                	push   $0x48
  jmp alltraps
80105d82:	e9 c8 f8 ff ff       	jmp    8010564f <alltraps>
...
80105d89:	6a 49                	push   $0x49
  jmp alltraps
80105d8b:	e9 bf f8 ff ff       	jmp    8010564f <alltraps>
...
80105d92:	6a 4a                	push   $0x4a
  jmp alltraps
80105d94:	e9 b6 f8 ff ff       	jmp    8010564f <alltraps>
...
80105d9b:	6a 4b                	push   $0x4b
  jmp alltraps
80105d9d:	e9 ad f8 ff ff       	jmp    8010564f <alltraps>
...
80105da4:	6a 4c                	push   $0x4c
  jmp alltraps
80105da6:	e9 a4 f8 ff ff       	jmp    8010564f <alltraps>
...
80105dad:	6a 4d                	push   $0x4d
  jmp alltraps
80105daf:	e9 9b f8 ff ff       	jmp    8010564f <alltraps>
...
80105db6:	6a 4e                	push   $0x4e
  jmp alltraps
80105db8:	e9 92 f8 ff ff       	jmp    8010564f <alltraps>
...
80105dbf:	6a 4f                	push   $0x4f
  jmp alltraps
80105dc1:	e9 89 f8 ff ff       	jmp    8010564f <alltraps>
...
80105dc8:	6a 50                	push   $0x50
  jmp alltraps
80105dca:	e9 80 f8 ff ff       	jmp    8010564f <alltraps>
...
80105dd1:	6a 51                	push   $0x51
  jmp alltraps
80105dd3:	e9 77 f8 ff ff       	jmp    8010564f <alltraps>
...
80105dda:	6a 52                	push   $0x52
  jmp alltraps
80105ddc:	e9 6e f8 ff ff       	jmp    8010564f <alltraps>
...
80105de3:	6a 53                	push   $0x53
  jmp alltraps
80105de5:	e9 65 f8 ff ff       	jmp    8010564f <alltraps>
...
80105dec:	6a 54                	push   $0x54
  jmp alltraps
80105dee:	e9 5c f8 ff ff       	jmp    8010564f <alltraps>
...
80105df5:	6a 55                	push   $0x55
  jmp alltraps
80105df7:	e9 53 f8 ff ff       	jmp    8010564f <alltraps>
...
80105dfe:	6a 56                	push   $0x56
  jmp alltraps
80105e00:	e9 4a f8 ff ff       	jmp    8010564f <alltraps>
...
80105e07:	6a 57                	push   $0x57
  jmp alltraps
80105e09:	e9 41 f8 ff ff       	jmp    8010564f <alltraps>
...
80105e10:	6a 58                	push   $0x58
  jmp alltraps
80105e12:	e9 38 f8 ff ff       	jmp    8010564f <alltraps>
...
80105e19:	6a 59                	push   $0x59
  jmp alltraps
80105e1b:	e9 2f f8 ff ff       	jmp    8010564f <alltraps>
...
80105e22:	6a 5a                	push   $0x5a
  jmp alltraps
80105e24:	e9 26 f8 ff ff       	jmp    8010564f <alltraps>
...
80105e2b:	6a 5b                	push   $0x5b
  jmp alltraps
80105e2d:	e9 1d f8 ff ff       	jmp    8010564f <alltraps>
...
80105e34:	6a 5c                	push   $0x5c
  jmp alltraps
80105e36:	e9 14 f8 ff ff       	jmp    8010564f <alltraps>
...
80105e3d:	6a 5d                	push   $0x5d
  jmp alltraps
80105e3f:	e9 0b f8 ff ff       	jmp    8010564f <alltraps>
...
80105e46:	6a 5e                	push   $0x5e
  jmp alltraps
80105e48:	e9 02 f8 ff ff       	jmp    8010564f <alltraps>
...
80105e4f:	6a 5f                	push   $0x5f
  jmp alltraps
80105e51:	e9 f9 f7 ff ff       	jmp    8010564f <alltraps>
...
80105e58:	6a 60                	push   $0x60
  jmp alltraps
80105e5a:	e9 f0 f7 ff ff       	jmp    8010564f <alltraps>
...
80105e61:	6a 61                	push   $0x61
  jmp alltraps
80105e63:	e9 e7 f7 ff ff       	jmp    8010564f <alltraps>
...
80105e6a:	6a 62                	push   $0x62
  jmp alltraps
80105e6c:	e9 de f7 ff ff       	jmp    8010564f <alltraps>
...
80105e73:	6a 63                	push   $0x63
  jmp alltraps
80105e75:	e9 d5 f7 ff ff       	jmp    8010564f <alltraps>
...
80105e7c:	6a 64                	push   $0x64
  jmp alltraps
80105e7e:	e9 cc f7 ff ff       	jmp    8010564f <alltraps>
...
80105e85:	6a 65                	push   $0x65
  jmp alltraps
80105e87:	e9 c3 f7 ff ff       	jmp    8010564f <alltraps>
...
80105e8e:	6a 66                	push   $0x66
  jmp alltraps
80105e90:	e9 ba f7 ff ff       	jmp    8010564f <alltraps>
...
80105e97:	6a 67                	push   $0x67
  jmp alltraps
80105e99:	e9 b1 f7 ff ff       	jmp    8010564f <alltraps>
...
80105ea0:	6a 68                	push   $0x68
  jmp alltraps
80105ea2:	e9 a8 f7 ff ff       	jmp    8010564f <alltraps>
...
80105ea9:	6a 69                	push   $0x69
  jmp alltraps
80105eab:	e9 9f f7 ff ff       	jmp    8010564f <alltraps>
...
80105eb2:	6a 6a                	push   $0x6a
  jmp alltraps
80105eb4:	e9 96 f7 ff ff       	jmp    8010564f <alltraps>
...
80105ebb:	6a 6b                	push   $0x6b
  jmp alltraps
80105ebd:	e9 8d f7 ff ff       	jmp    8010564f <alltraps>
...
80105ec4:	6a 6c                	push   $0x6c
  jmp alltraps
80105ec6:	e9 84 f7 ff ff       	jmp    8010564f <alltraps>
...
80105ecd:	6a 6d                	push   $0x6d
  jmp alltraps
80105ecf:	e9 7b f7 ff ff       	jmp    8010564f <alltraps>
...
80105ed6:	6a 6e                	push   $0x6e
  jmp alltraps
80105ed8:	e9 72 f7 ff ff       	jmp    8010564f <alltraps>
...
80105edf:	6a 6f                	push   $0x6f
  jmp alltraps
80105ee1:	e9 69 f7 ff ff       	jmp    8010564f <alltraps>
...
80105ee8:	6a 70                	push   $0x70
  jmp alltraps
80105eea:	e9 60 f7 ff ff       	jmp    8010564f <alltraps>
...
80105ef1:	6a 71                	push   $0x71
  jmp alltraps
80105ef3:	e9 57 f7 ff ff       	jmp    8010564f <alltraps>
...
80105efa:	6a 72                	push   $0x72
  jmp alltraps
80105efc:	e9 4e f7 ff ff       	jmp    8010564f <alltraps>
...
80105f03:	6a 73                	push   $0x73
  jmp alltraps
80105f05:	e9 45 f7 ff ff       	jmp    8010564f <alltraps>
...
80105f0c:	6a 74                	push   $0x74
  jmp alltraps
80105f0e:	e9 3c f7 ff ff       	jmp    8010564f <alltraps>
...
80105f15:	6a 75                	push   $0x75
  jmp alltraps
80105f17:	e9 33 f7 ff ff       	jmp    8010564f <alltraps>
...
80105f1e:	6a 76                	push   $0x76
  jmp alltraps
80105f20:	e9 2a f7 ff ff       	jmp    8010564f <alltraps>
...
80105f27:	6a 77                	push   $0x77
  jmp alltraps
80105f29:	e9 21 f7 ff ff       	jmp    8010564f <alltraps>
...
80105f30:	6a 78                	push   $0x78
  jmp alltraps
80105f32:	e9 18 f7 ff ff       	jmp    8010564f <alltraps>
...
80105f39:	6a 79                	push   $0x79
  jmp alltraps
80105f3b:	e9 0f f7 ff ff       	jmp    8010564f <alltraps>
...
80105f42:	6a 7a                	push   $0x7a
  jmp alltraps
80105f44:	e9 06 f7 ff ff       	jmp    8010564f <alltraps>
...
80105f4b:	6a 7b                	push   $0x7b
  jmp alltraps
80105f4d:	e9 fd f6 ff ff       	jmp    8010564f <alltraps>
...
80105f54:	6a 7c                	push   $0x7c
  jmp alltraps
80105f56:	e9 f4 f6 ff ff       	jmp    8010564f <alltraps>
...
80105f5d:	6a 7d                	push   $0x7d
  jmp alltraps
80105f5f:	e9 eb f6 ff ff       	jmp    8010564f <alltraps>
...
80105f66:	6a 7e                	push   $0x7e
  jmp alltraps
80105f68:	e9 e2 f6 ff ff       	jmp    8010564f <alltraps>
...
80105f6f:	6a 7f                	push   $0x7f
  jmp alltraps
80105f71:	e9 d9 f6 ff ff       	jmp    8010564f <alltraps>
...
80105f78:	68 80 00 00 00       	push   $0x80
  jmp alltraps
80105f7d:	e9 cd f6 ff ff       	jmp    8010564f <alltraps>
...
80105f84:	68 81 00 00 00       	push   $0x81
  jmp alltraps
80105f89:	e9 c1 f6 ff ff       	jmp    8010564f <alltraps>
...
80105f90:	68 82 00 00 00       	push   $0x82
  jmp alltraps
80105f95:	e9 b5 f6 ff ff       	jmp    8010564f <alltraps>
...
80105f9c:	68 83 00 00 00       	push   $0x83
  jmp alltraps
80105fa1:	e9 a9 f6 ff ff       	jmp    8010564f <alltraps>
...
80105fa8:	68 84 00 00 00       	push   $0x84
  jmp alltraps
80105fad:	e9 9d f6 ff ff       	jmp    8010564f <alltraps>
...
80105fb4:	68 85 00 00 00       	push   $0x85
  jmp alltraps
80105fb9:	e9 91 f6 ff ff       	jmp    8010564f <alltraps>
...
80105fc0:	68 86 00 00 00       	push   $0x86
  jmp alltraps
80105fc5:	e9 85 f6 ff ff       	jmp    8010564f <alltraps>
...
80105fcc:	68 87 00 00 00       	push   $0x87
  jmp alltraps
80105fd1:	e9 79 f6 ff ff       	jmp    8010564f <alltraps>
...
80105fd8:	68 88 00 00 00       	push   $0x88
  jmp alltraps
80105fdd:	e9 6d f6 ff ff       	jmp    8010564f <alltraps>
...
80105fe4:	68 89 00 00 00       	push   $0x89
  jmp alltraps
80105fe9:	e9 61 f6 ff ff       	jmp    8010564f <alltraps>
...
80105ff0:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
80105ff5:	e9 55 f6 ff ff       	jmp    8010564f <alltraps>
...
80105ffc:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
80106001:	e9 49 f6 ff ff       	jmp    8010564f <alltraps>
...
80106008:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
8010600d:	e9 3d f6 ff ff       	jmp    8010564f <alltraps>
...
80106014:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
80106019:	e9 31 f6 ff ff       	jmp    8010564f <alltraps>
...
80106020:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
80106025:	e9 25 f6 ff ff       	jmp    8010564f <alltraps>
...
8010602c:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
80106031:	e9 19 f6 ff ff       	jmp    8010564f <alltraps>
...
80106038:	68 90 00 00 00       	push   $0x90
  jmp alltraps
8010603d:	e9 0d f6 ff ff       	jmp    8010564f <alltraps>
...
80106044:	68 91 00 00 00       	push   $0x91
  jmp alltraps
80106049:	e9 01 f6 ff ff       	jmp    8010564f <alltraps>
...
80106050:	68 92 00 00 00       	push   $0x92
  jmp alltraps
80106055:	e9 f5 f5 ff ff       	jmp    8010564f <alltraps>
...
8010605c:	68 93 00 00 00       	push   $0x93
  jmp alltraps
80106061:	e9 e9 f5 ff ff       	jmp    8010564f <alltraps>
...
80106068:	68 94 00 00 00       	push   $0x94
  jmp alltraps
8010606d:	e9 dd f5 ff ff       	jmp    8010564f <alltraps>
...
80106074:	68 95 00 00 00       	push   $0x95
  jmp alltraps
80106079:	e9 d1 f5 ff ff       	jmp    8010564f <alltraps>
...
80106080:	68 96 00 00 00       	push   $0x96
  jmp alltraps
80106085:	e9 c5 f5 ff ff       	jmp    8010564f <alltraps>
...
8010608c:	68 97 00 00 00       	push   $0x97
  jmp alltraps
80106091:	e9 b9 f5 ff ff       	jmp    8010564f <alltraps>
...
80106098:	68 98 00 00 00       	push   $0x98
  jmp alltraps
8010609d:	e9 ad f5 ff ff       	jmp    8010564f <alltraps>
...
801060a4:	68 99 00 00 00       	push   $0x99
  jmp alltraps
801060a9:	e9 a1 f5 ff ff       	jmp    8010564f <alltraps>
...
801060b0:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
801060b5:	e9 95 f5 ff ff       	jmp    8010564f <alltraps>
...
801060bc:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
801060c1:	e9 89 f5 ff ff       	jmp    8010564f <alltraps>
...
801060c8:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
801060cd:	e9 7d f5 ff ff       	jmp    8010564f <alltraps>
...
801060d4:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
801060d9:	e9 71 f5 ff ff       	jmp    8010564f <alltraps>
...
801060e0:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
801060e5:	e9 65 f5 ff ff       	jmp    8010564f <alltraps>
...
801060ec:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
801060f1:	e9 59 f5 ff ff       	jmp    8010564f <alltraps>
...
801060f8:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
801060fd:	e9 4d f5 ff ff       	jmp    8010564f <alltraps>
...
80106104:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
80106109:	e9 41 f5 ff ff       	jmp    8010564f <alltraps>
...
80106110:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
80106115:	e9 35 f5 ff ff       	jmp    8010564f <alltraps>
...
8010611c:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
80106121:	e9 29 f5 ff ff       	jmp    8010564f <alltraps>
...
80106128:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
8010612d:	e9 1d f5 ff ff       	jmp    8010564f <alltraps>
...
80106134:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
80106139:	e9 11 f5 ff ff       	jmp    8010564f <alltraps>
...
80106140:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
80106145:	e9 05 f5 ff ff       	jmp    8010564f <alltraps>
...
8010614c:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
80106151:	e9 f9 f4 ff ff       	jmp    8010564f <alltraps>
...
80106158:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
8010615d:	e9 ed f4 ff ff       	jmp    8010564f <alltraps>
...
80106164:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
80106169:	e9 e1 f4 ff ff       	jmp    8010564f <alltraps>
...
80106170:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
80106175:	e9 d5 f4 ff ff       	jmp    8010564f <alltraps>
...
8010617c:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
80106181:	e9 c9 f4 ff ff       	jmp    8010564f <alltraps>
...
80106188:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
8010618d:	e9 bd f4 ff ff       	jmp    8010564f <alltraps>
...
80106194:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
80106199:	e9 b1 f4 ff ff       	jmp    8010564f <alltraps>
...
801061a0:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
801061a5:	e9 a5 f4 ff ff       	jmp    8010564f <alltraps>
...
801061ac:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
801061b1:	e9 99 f4 ff ff       	jmp    8010564f <alltraps>
...
801061b8:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
801061bd:	e9 8d f4 ff ff       	jmp    8010564f <alltraps>
...
801061c4:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
801061c9:	e9 81 f4 ff ff       	jmp    8010564f <alltraps>
...
801061d0:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
801061d5:	e9 75 f4 ff ff       	jmp    8010564f <alltraps>
...
801061dc:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
801061e1:	e9 69 f4 ff ff       	jmp    8010564f <alltraps>
...
801061e8:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
801061ed:	e9 5d f4 ff ff       	jmp    8010564f <alltraps>
...
801061f4:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
801061f9:	e9 51 f4 ff ff       	jmp    8010564f <alltraps>
...
80106200:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
80106205:	e9 45 f4 ff ff       	jmp    8010564f <alltraps>
...
8010620c:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
80106211:	e9 39 f4 ff ff       	jmp    8010564f <alltraps>
...
80106218:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
8010621d:	e9 2d f4 ff ff       	jmp    8010564f <alltraps>
...
80106224:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
80106229:	e9 21 f4 ff ff       	jmp    8010564f <alltraps>
...
80106230:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
80106235:	e9 15 f4 ff ff       	jmp    8010564f <alltraps>
...
8010623c:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
80106241:	e9 09 f4 ff ff       	jmp    8010564f <alltraps>
...
80106248:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
8010624d:	e9 fd f3 ff ff       	jmp    8010564f <alltraps>
...
80106254:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
80106259:	e9 f1 f3 ff ff       	jmp    8010564f <alltraps>
...
80106260:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
80106265:	e9 e5 f3 ff ff       	jmp    8010564f <alltraps>
...
8010626c:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
80106271:	e9 d9 f3 ff ff       	jmp    8010564f <alltraps>
...
80106278:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
8010627d:	e9 cd f3 ff ff       	jmp    8010564f <alltraps>
...
80106284:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
80106289:	e9 c1 f3 ff ff       	jmp    8010564f <alltraps>
...
80106290:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
80106295:	e9 b5 f3 ff ff       	jmp    8010564f <alltraps>
...
8010629c:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
801062a1:	e9 a9 f3 ff ff       	jmp    8010564f <alltraps>
...
801062a8:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
801062ad:	e9 9d f3 ff ff       	jmp    8010564f <alltraps>
...
801062b4:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
801062b9:	e9 91 f3 ff ff       	jmp    8010564f <alltraps>
...
801062c0:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
801062c5:	e9 85 f3 ff ff       	jmp    8010564f <alltraps>
...
801062cc:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
801062d1:	e9 79 f3 ff ff       	jmp    8010564f <alltraps>
...
801062d8:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
801062dd:	e9 6d f3 ff ff       	jmp    8010564f <alltraps>
...
801062e4:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
801062e9:	e9 61 f3 ff ff       	jmp    8010564f <alltraps>
...
801062f0:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
801062f5:	e9 55 f3 ff ff       	jmp    8010564f <alltraps>
...
801062fc:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
80106301:	e9 49 f3 ff ff       	jmp    8010564f <alltraps>
...
80106308:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
8010630d:	e9 3d f3 ff ff       	jmp    8010564f <alltraps>
...
80106314:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
80106319:	e9 31 f3 ff ff       	jmp    8010564f <alltraps>
...
80106320:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
80106325:	e9 25 f3 ff ff       	jmp    8010564f <alltraps>
...
8010632c:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
80106331:	e9 19 f3 ff ff       	jmp    8010564f <alltraps>
...
80106338:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
8010633d:	e9 0d f3 ff ff       	jmp    8010564f <alltraps>
...
80106344:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
80106349:	e9 01 f3 ff ff       	jmp    8010564f <alltraps>
...
80106350:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
80106355:	e9 f5 f2 ff ff       	jmp    8010564f <alltraps>
...
8010635c:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
80106361:	e9 e9 f2 ff ff       	jmp    8010564f <alltraps>
...
80106368:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
8010636d:	e9 dd f2 ff ff       	jmp    8010564f <alltraps>
...
80106374:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
80106379:	e9 d1 f2 ff ff       	jmp    8010564f <alltraps>
...
80106380:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
80106385:	e9 c5 f2 ff ff       	jmp    8010564f <alltraps>
...
8010638c:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
80106391:	e9 b9 f2 ff ff       	jmp    8010564f <alltraps>
...
80106398:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
8010639d:	e9 ad f2 ff ff       	jmp    8010564f <alltraps>
...
801063a4:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
801063a9:	e9 a1 f2 ff ff       	jmp    8010564f <alltraps>
...
801063b0:	68 da 00 00 00       	push   $0xda
  jmp alltraps
801063b5:	e9 95 f2 ff ff       	jmp    8010564f <alltraps>
...
801063bc:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
801063c1:	e9 89 f2 ff ff       	jmp    8010564f <alltraps>
...
801063c8:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
801063cd:	e9 7d f2 ff ff       	jmp    8010564f <alltraps>
...
801063d4:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
801063d9:	e9 71 f2 ff ff       	jmp    8010564f <alltraps>
...
801063e0:	68 de 00 00 00       	push   $0xde
  jmp alltraps
801063e5:	e9 65 f2 ff ff       	jmp    8010564f <alltraps>
...
801063ec:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
801063f1:	e9 59 f2 ff ff       	jmp    8010564f <alltraps>
...
801063f8:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
801063fd:	e9 4d f2 ff ff       	jmp    8010564f <alltraps>
...
80106404:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
80106409:	e9 41 f2 ff ff       	jmp    8010564f <alltraps>
...
80106410:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
80106415:	e9 35 f2 ff ff       	jmp    8010564f <alltraps>
...
8010641c:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
80106421:	e9 29 f2 ff ff       	jmp    8010564f <alltraps>
...
80106428:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
8010642d:	e9 1d f2 ff ff       	jmp    8010564f <alltraps>
...
80106434:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
80106439:	e9 11 f2 ff ff       	jmp    8010564f <alltraps>
...
80106440:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
80106445:	e9 05 f2 ff ff       	jmp    8010564f <alltraps>
...
8010644c:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
80106451:	e9 f9 f1 ff ff       	jmp    8010564f <alltraps>
...
80106458:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
8010645d:	e9 ed f1 ff ff       	jmp    8010564f <alltraps>
...
80106464:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
80106469:	e9 e1 f1 ff ff       	jmp    8010564f <alltraps>
...
80106470:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
80106475:	e9 d5 f1 ff ff       	jmp    8010564f <alltraps>
...
8010647c:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
80106481:	e9 c9 f1 ff ff       	jmp    8010564f <alltraps>
...
80106488:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
8010648d:	e9 bd f1 ff ff       	jmp    8010564f <alltraps>
...
80106494:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
80106499:	e9 b1 f1 ff ff       	jmp    8010564f <alltraps>
...
801064a0:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
801064a5:	e9 a5 f1 ff ff       	jmp    8010564f <alltraps>
...
801064ac:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
801064b1:	e9 99 f1 ff ff       	jmp    8010564f <alltraps>
...
801064b8:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
801064bd:	e9 8d f1 ff ff       	jmp    8010564f <alltraps>
...
801064c4:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
801064c9:	e9 81 f1 ff ff       	jmp    8010564f <alltraps>
...
801064d0:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
801064d5:	e9 75 f1 ff ff       	jmp    8010564f <alltraps>
...
801064dc:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
801064e1:	e9 69 f1 ff ff       	jmp    8010564f <alltraps>
...
801064e8:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
801064ed:	e9 5d f1 ff ff       	jmp    8010564f <alltraps>
...
801064f4:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
801064f9:	e9 51 f1 ff ff       	jmp    8010564f <alltraps>
...
80106500:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
80106505:	e9 45 f1 ff ff       	jmp    8010564f <alltraps>
...
8010650c:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
80106511:	e9 39 f1 ff ff       	jmp    8010564f <alltraps>
...
80106518:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
8010651d:	e9 2d f1 ff ff       	jmp    8010564f <alltraps>
...
80106524:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
80106529:	e9 21 f1 ff ff       	jmp    8010564f <alltraps>
...
80106530:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
80106535:	e9 15 f1 ff ff       	jmp    8010564f <alltraps>
...
8010653c:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
80106541:	e9 09 f1 ff ff       	jmp    8010564f <alltraps>
...
80106548:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
8010654d:	e9 fd f0 ff ff       	jmp    8010564f <alltraps>
...
80106554:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
80106559:	e9 f1 f0 ff ff       	jmp    8010564f <alltraps>
...
80106560:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
80106565:	e9 e5 f0 ff ff       	jmp    8010564f <alltraps>
...
8010656c:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
80106571:	e9 d9 f0 ff ff       	jmp    8010564f <alltraps>
...
801065e2:	e8 49 de ff ff       	call   80104430 <memset>
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
...
80106681:	c3                   	ret    
      panic("remap");
80106682:	c7 04 24 b4 77 10 80 	movl   $0x801077b4,(%esp)
...
801067f0:	a1 a4 55 11 80       	mov    0x801155a4,%eax
{
...
801068eb:	5d                   	pop    %ebp
  popcli();
801068ec:	e9 cf d9 ff ff       	jmp    801042c0 <popcli>
    panic("switchuvm: no process");
801068f1:	c7 04 24 ba 77 10 80 	movl   $0x801077ba,(%esp)
801068f8:	e8 63 9a ff ff       	call   80100360 <panic>
    panic("switchuvm: no pgdir");
801068fd:	c7 04 24 e5 77 10 80 	movl   $0x801077e5,(%esp)
80106904:	e8 57 9a ff ff       	call   80100360 <panic>
    panic("switchuvm: no kstack");
80106909:	c7 04 24 d0 77 10 80 	movl   $0x801077d0,(%esp)
...
80106957:	e8 d4 da ff ff       	call   80104430 <memset>
...
8010698b:	5d                   	pop    %ebp
  memmove(mem, init, sz);
8010698c:	e9 3f db ff ff       	jmp    801044d0 <memmove>
    panic("inituvm: more than a page");
80106991:	c7 04 24 f9 77 10 80 	movl   $0x801077f9,(%esp)
...
80106a42:	c7 04 24 13 78 10 80 	movl   $0x80107813,(%esp)
80106a49:	e8 12 99 ff ff       	call   80100360 <panic>
    panic("loaduvm: addr must be page aligned");
80106a4e:	c7 04 24 b4 78 10 80 	movl   $0x801078b4,(%esp)
...
80106aa3:	e8 88 d9 ff ff       	call   80104430 <memset>
...
80106ae1:	c7 04 24 31 78 10 80 	movl   $0x80107831,(%esp)
...
80106b10:	c7 04 24 49 78 10 80 	movl   $0x80107849,(%esp)
...
80106bd3:	e9 18 b7 ff ff       	jmp    801022f0 <kfree>
    panic("freevm: no pgdir");
80106bd8:	c7 04 24 65 78 10 80 	movl   $0x80107865,(%esp)
...
80106c1b:	e8 10 d8 ff ff       	call   80104430 <memset>
...
80106cbb:	c3                   	ret    
    panic("clearpteu");
80106cbc:	c7 04 24 76 78 10 80 	movl   $0x80107876,(%esp)
...
80106d0d:	e8 be d7 ff ff       	call   801044d0 <memmove>
...
80106da4:	eb d8                	jmp    80106d7e <copyuvm+0xae>
      panic("copyuvm: page not present");
80106da6:	c7 04 24 9a 78 10 80 	movl   $0x8010789a,(%esp)
80106dad:	e8 ae 95 ff ff       	call   80100360 <panic>
      panic("copyuvm: pte should exist");
80106db2:	c7 04 24 80 78 10 80 	movl   $0x80107880,(%esp)
...
80106e3c:	e8 8f d6 ff ff       	call   801044d0 <memmove>
    len -= n;
    buf += n;
