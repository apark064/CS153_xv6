...
00000e12 <waitpid>:
SYSCALL(waitpid)
     e12:	b8 17 00 00 00       	mov    $0x17,%eax
     e17:	cd 40                	int    $0x40
     e19:	c3                   	ret    
...
00000eaa <add>:
SYSCALL(add)
     eaa:	b8 16 00 00 00       	mov    $0x16,%eax
     eaf:	cd 40                	int    $0x40
     eb1:	c3                   	ret    
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  write(fd, &c, 1);
     ...
     f3a:	e8 eb fe ff ff       	call   e2a <write>
  while(--i >= 0)
     ...
     f6e:	8d 45 10             	lea    0x10(%ebp),%eax
{
  ...
  write(fd, &c, 1);
     fa6:	e8 7f fe ff ff       	call   e2a <write>
  ...
  write(fd, &c, 1);
    ...
    1016:	e8 0f fe ff ff       	call   e2a <write>
        putc(fd, c);
  ...
  write(fd, &c, 1);
    1033:	e8 f2 fd ff ff       	call   e2a <write>
  for(i = 0; fmt[i]; i++){
  ...
  write(fd, &c, 1);
    ...
    10c0:	e8 65 fd ff ff       	call   e2a <write>
        while(*s != 0){
  ...
  write(fd, &c, 1);
    ...
    10f0:	e8 35 fd ff ff       	call   e2a <write>
  ...
  write(fd, &c, 1);
    ...
    1140:	e8 e5 fc ff ff       	call   e2a <write>
        ap++;
...
malloc(uint nbytes)
{
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    124a:	e8 43 fc ff ff       	call   e92 <sbrk>
  if(p == (char*)-1)
